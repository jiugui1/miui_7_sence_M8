...
.method protected constructor <init>(Landroid/content/Context;Lcom/android/server/power/PowerManagerService$PMSInternalAPI;I)V
    ...
    iput-wide v1, p0, Lcom/android/server/power/HtcWakeLockMonitor;->DUMP_RECORD_INTERVAL:J
    ...
    iput-wide v1, p0, Lcom/android/server/power/HtcWakeLockMonitor;->MINIMUM_DURATION:J

    .line 64
    const-wide/16 v1, 0x7530

    iput-wide v1, p0, Lcom/android/server/power/HtcWakeLockMonitor;->SCREEN_OFF_MINIMUM:J

    .line 65
    iput v9, p0, Lcom/android/server/power/HtcWakeLockMonitor;->SCREEN_OFF_RATIO:I

    .line 66
    iput v9, p0, Lcom/android/server/power/HtcWakeLockMonitor;->WL_HELD_RATIO:I
    ...
    .line 106
    iput-wide v7, p0, Lcom/android/server/power/HtcWakeLockMonitor;->mLastScanTime:J

    .line 108
    iput-wide v7, p0, Lcom/android/server/power/HtcWakeLockMonitor;->mTotalScreenOffTime:J

    .line 109
    iput-wide v7, p0, Lcom/android/server/power/HtcWakeLockMonitor;->mTotalTime:J
    ...
    .line 120
    iput-object p2, p0, Lcom/android/server/power/HtcWakeLockMonitor;->mPMSInternalAPI:Lcom/android/server/power/PowerManagerService$PMSInternalAPI;
    ...
    .line 130
    iget-wide v1, p0, Lcom/android/server/power/HtcWakeLockMonitor;->MINIMUM_DURATION:J

    iget-wide v3, p0, Lcom/android/server/power/HtcWakeLockMonitor;->SCREEN_OFF_MINIMUM:J
...
.method static synthetic access$2700(Lcom/android/server/power/HtcWakeLockMonitor;)Lcom/android/server/power/PowerManagerService$PMSInternalAPI;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/HtcWakeLockMonitor;

    .prologue
    .line 33
    iget-object v0, p0, Lcom/android/server/power/HtcWakeLockMonitor;->mPMSInternalAPI:Lcom/android/server/power/PowerManagerService$PMSInternalAPI;
...
.method private criteriaToString()Ljava/lang/String;
    ...
    iget-wide v1, p0, Lcom/android/server/power/HtcWakeLockMonitor;->SCREEN_OFF_MINIMUM:J
...
.method private getSumByOffset([[JJ)[J
    ...
    const-string v22, "getSumByOffset: Abnormal case found.("
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/power/HtcWakeLockMonitor$LockRecordList;->iterator()Ljava/util/Iterator;
    ...
    check-cast v15, Lcom/android/server/power/HtcWakeLockMonitor$WakeLockRecord;

    .line 530
    .local v15, "record":Lcom/android/server/power/HtcWakeLockMonitor$WakeLockRecord;
    # getter for: Lcom/android/server/power/HtcWakeLockMonitor$WakeLockRecord;->heldDuration:[J
    invoke-static {v15}, Lcom/android/server/power/HtcWakeLockMonitor$WakeLockRecord;->access$1300(Lcom/android/server/power/HtcWakeLockMonitor$WakeLockRecord;)[J
    ...
    .end local v15    # "record":Lcom/android/server/power/HtcWakeLockMonitor$WakeLockRecord;
    :catch_0
    move-exception v12
...
.method private readSysProp()V
    ...
    iget-boolean v5, v0, Lcom/android/server/power/HtcWakeLockMonitor;->DEBUG_ON:Z

    .line 283
    .local v5, "old_debug_on":Z
    move-object/from16 v0, p0

    iget-boolean v6, v0, Lcom/android/server/power/HtcWakeLockMonitor;->ENABLE_MONITOR:Z

    .line 284
    .local v6, "old_enable_monitor":Z
    move-object/from16 v0, p0

    iget v13, v0, Lcom/android/server/power/HtcWakeLockMonitor;->WHITELIST_VALID_UID:I

    .line 285
    .local v13, "old_whitelist_valid_uid":I
    move-object/from16 v0, p0

    iget v12, v0, Lcom/android/server/power/HtcWakeLockMonitor;->UID_CHECK_RANGE:I

    .line 286
    .local v12, "old_uid_check_range":I
    move-object/from16 v0, p0

    iget-wide v7, v0, Lcom/android/server/power/HtcWakeLockMonitor;->MINIMUM_DURATION:J

    .line 287
    .local v7, "old_minimum_duration":J
    move-object/from16 v0, p0

    iget-wide v9, v0, Lcom/android/server/power/HtcWakeLockMonitor;->SCREEN_OFF_MINIMUM:J

    .line 288
    .local v9, "old_screen_off_minimum":J
    move-object/from16 v0, p0

    iget v11, v0, Lcom/android/server/power/HtcWakeLockMonitor;->SCREEN_OFF_RATIO:I

    .line 289
    .local v11, "old_screen_off_ratio":I
    move-object/from16 v0, p0

    iget v14, v0, Lcom/android/server/power/HtcWakeLockMonitor;->WL_HELD_RATIO:I

    .line 290
    .local v14, "old_wl_held_ratio":I
    move-object/from16 v0, p0

    iget v4, v0, Lcom/android/server/power/HtcWakeLockMonitor;->ABNORMAL_COUNT:I
    ...
    iput-boolean v15, v0, Lcom/android/server/power/HtcWakeLockMonitor;->DEBUG_ON:Z
    ...
    iput-boolean v15, v0, Lcom/android/server/power/HtcWakeLockMonitor;->ENABLE_MONITOR:Z
    ...
    iput v15, v0, Lcom/android/server/power/HtcWakeLockMonitor;->WHITELIST_VALID_UID:I
    ...
    iput v15, v0, Lcom/android/server/power/HtcWakeLockMonitor;->UID_CHECK_RANGE:I
    ...
    iput-wide v15, v0, Lcom/android/server/power/HtcWakeLockMonitor;->MINIMUM_DURATION:J
    ...
    iput-wide v15, v0, Lcom/android/server/power/HtcWakeLockMonitor;->SCREEN_OFF_MINIMUM:J
    ...
    iput v15, v0, Lcom/android/server/power/HtcWakeLockMonitor;->SCREEN_OFF_RATIO:I
    ...
    iput v15, v0, Lcom/android/server/power/HtcWakeLockMonitor;->WL_HELD_RATIO:I
    ...
    iput v15, v0, Lcom/android/server/power/HtcWakeLockMonitor;->ABNORMAL_COUNT:I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-boolean v15, v0, Lcom/android/server/power/HtcWakeLockMonitor;->DEBUG_ON:Z
...
.method protected screenState(Z)V
    ...
    iget-wide v11, p0, Lcom/android/server/power/HtcWakeLockMonitor;->MINIMUM_DURATION:J

    invoke-direct {p0, v10, v11, v12}, Lcom/android/server/power/HtcWakeLockMonitor;->getSumByOffset([[JJ)[J
    ...
    iget-wide v11, p0, Lcom/android/server/power/HtcWakeLockMonitor;->mTotalScreenOffTime:J
    ...
    iget-wide v11, p0, Lcom/android/server/power/HtcWakeLockMonitor;->mTotalTime:J

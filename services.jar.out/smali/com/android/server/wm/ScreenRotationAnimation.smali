...
.method private stepAnimation(J)Z
    ...
    .line 747
    iget-wide v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mHalfwayPoint:J
    ...
    iput-wide v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mHalfwayPoint:J

    .line 750
    :cond_0
    iget-boolean v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mFinishAnimReady:Z

    if-eqz v6, :cond_1

    iget-wide v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mFinishAnimStartTime:J
    ...
    .line 801
    iget-object v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mRotateExitAnimation:Landroid/view/animation/Animation;
    ...
    iget-object v7, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mRotateExitTransformation:Landroid/view/animation/Transformation;

    invoke-virtual {v6, p1, p2, v7}, Landroid/view/animation/Animation;->getTransformation(JLandroid/view/animation/Transformation;)Z

    move-result v6

    iput-boolean v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mMoreRotateExit:Z
    ...
    .line 807
    iget-object v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mRotateEnterAnimation:Landroid/view/animation/Animation;
    ...
    iget-object v7, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mRotateEnterTransformation:Landroid/view/animation/Transformation;

    invoke-virtual {v6, p1, p2, v7}, Landroid/view/animation/Animation;->getTransformation(JLandroid/view/animation/Transformation;)Z

    move-result v6

    iput-boolean v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mMoreRotateEnter:Z

    .line 820
    :cond_4
    iget-boolean v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mMoreRotateExit:Z
    ...
    .line 839
    iget-object v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mRotateExitTransformation:Landroid/view/animation/Transformation;

    invoke-virtual {v6}, Landroid/view/animation/Transformation;->clear()V

    .line 843
    :cond_5
    iget-boolean v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mMoreRotateEnter:Z
    ...
    .line 862
    iget-object v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mRotateEnterTransformation:Landroid/view/animation/Transformation;
    ...
    invoke-virtual {v6, v7}, Landroid/view/animation/Transformation;->set(Landroid/view/animation/Transformation;)V

    .line 888
    iget-object v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mEnterTransformation:Landroid/view/animation/Transformation;
    ...
    .local v3, "more":Z
    :cond_8
    iget-object v6, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mSnapshotFinalMatrix:Landroid/graphics/Matrix;

    iget-object v7, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mExitTransformation:Landroid/view/animation/Transformation;

    invoke-virtual {v7}, Landroid/view/animation/Transformation;->getMatrix()Landroid/graphics/Matrix;

    move-result-object v7

    iget-object v8, p0, Lcom/android/server/wm/ScreenRotationAnimation;->mSnapshotInitialMatrix:Landroid/graphics/Matrix;

    invoke-virtual {v6, v7, v8}, Landroid/graphics/Matrix;->setConcat(Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Z
    ...
    .line 936
    invoke-virtual {v4, v5}, Lcom/htc/service/WirelessDisplayManager;->requestDelayTimerStop(Z)V

    .line 945
    .end local v2    # "isMediaLinkOn":Z
    .end local v4    # "wdm":Lcom/htc/service/WirelessDisplayManager;
    :cond_a
    :goto_0
    return v3

    .line 939
    .restart local v2    # "isMediaLinkOn":Z
    .restart local v4    # "wdm":Lcom/htc/service/WirelessDisplayManager;
    :cond_b
    ...
    const-string v6, "stepAnimation, query WirelessDisplayManager fail!"

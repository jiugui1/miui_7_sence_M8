...
.field private static final KEY_NMEA:Ljava/lang/String; = "nmea"
...
.field private static final TAG_CAR_GPS:Ljava/lang/String; = "LocationManagerService_CarGps"
...
.field private final mSuperApps:[Ljava/lang/String;

.field private final mSuperRDsByProvider:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 237
    iput v2, p0, Lcom/android/server/LocationManagerService;->mBackdoorMode:I
    ...
    iput-object v0, p0, Lcom/android/server/LocationManagerService;->mSuperApps:[Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/server/LocationManagerService;->mSuperRDsByProvider:Ljava/util/HashMap;
...
.method static synthetic access$1400(Lcom/android/server/LocationManagerService;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;

    .prologue
    .line 103
    iget v0, p0, Lcom/android/server/LocationManagerService;->mBackdoorMode:I
...
.method static synthetic access$1800(Lcom/android/server/LocationManagerService;)Ljava/util/HashMap;
    ...
    .prologue
    .line 103
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mSuperRDsByProvider:Ljava/util/HashMap;
...
.method static synthetic access$600(Lcom/android/server/LocationManagerService;Ljava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    ...
    .prologue
    .line 103
    invoke-direct {p0, p1}, Lcom/android/server/LocationManagerService;->isSuperApp(Ljava/lang/String;)Z
...
.method private applyRequirementsForSuperAppLocked(Ljava/lang/String;)V
    .locals 13
    ...
    iget-boolean v9, v9, Lcom/android/server/LocationManagerService$Receiver;->isSuperApp:Z
    ...
    const-string v11, "provider request for super app: "
...
.method private checkMockPermissionsSafe()V
    ...
    invoke-virtual {v1}, Lcom/android/server/location/CarGpsProvider;->isHtcMode()Z
    ...
    invoke-virtual {v1}, Lcom/android/server/location/CarGpsProvider;->isUsedMock()Z
    ...
    .line 2645
    const-string v1, "LocationManagerService_CarGps"

    const-string v2, "checkMockPermissionsSafe: isHtcMode and using Mock"
...
.method private checkSuperMode()Z
    .locals 6

    .prologue
    .line 2970
    iget-object v4, p0, Lcom/android/server/LocationManagerService;->mSuperRDsByProvider:Ljava/util/HashMap;
    ...
    iget v4, v4, Lcom/android/server/LocationManagerService$Receiver;->mUid:I
...
.method private handleLocationChanged(Landroid/location/Location;Z)V
    ...
    invoke-direct {p0}, Lcom/android/server/LocationManagerService;->checkSuperMode()Z

    move-result v2

    if-eqz v2, :cond_3

    invoke-direct {p0, v1}, Lcom/android/server/LocationManagerService;->isUsedBySuperApp(Ljava/lang/String;)Z
...
.method private handleLocationChangedLocked(Landroid/location/Location;Z)V
    ...
    sub-long v31, v33, v35

    .line 2385
    .local v31, "timeDiffNanos":J
    const-wide v33, 0x8bb2c97000L

    cmp-long v33, v31, v33
    ...
    .restart local v31    # "timeDiffNanos":J
    :cond_a
    ...
    invoke-virtual/range {v33 .. v34}, Lcom/android/server/location/LocationBlacklist;->isBlacklisted(Ljava/lang/String;)Z
    ...
    cmp-long v33, v14, v22

    if-lez v33, :cond_14

    const-wide/16 v33, 0x0

    cmp-long v33, v22, v33
...
.method private isSuperApp(Ljava/lang/String;)Z
    .locals 4
    .param p1, "packageName"    # Ljava/lang/String;
    ...
    .line 2949
    :cond_1
    iget-object v3, p0, Lcom/android/server/LocationManagerService;->mSuperApps:[Ljava/lang/String;
...
.method private isUsedBySuperApp(Ljava/lang/String;)Z
    .locals 1
    .param p1, "provider"    # Ljava/lang/String;
...
.method private loadProvidersLocked()V
    ...
    .prologue
    .line 391
    new-instance v15, Lcom/android/server/location/PassiveProvider;

    move-object/from16 v0, p0

    invoke-direct {v15, v0}, Lcom/android/server/location/PassiveProvider;-><init>(Landroid/location/ILocationManager;)V

    .line 392
    .local v15, "passiveProvider":Lcom/android/server/location/PassiveProvider;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v15}, Lcom/android/server/location/PassiveProvider;->getName()Ljava/lang/String;
    ...
    iput-object v15, v0, Lcom/android/server/LocationManagerService;->mPassiveProvider:Lcom/android/server/location/PassiveProvider;
    ...
    iput-object v12, v0, Lcom/android/server/LocationManagerService;->mGpsLocationProvider:Lcom/android/server/location/LocationProviderInterface;
    ...
    .line 410
    .local v13, "lp":Lcom/android/server/location/LocationProviderInterface;
    if-eqz v13, :cond_6

    .line 411
    invoke-interface {v13}, Lcom/android/server/location/LocationProviderInterface;->getProperties()Lcom/android/internal/location/ProviderProperties;
    ...
    invoke-direct {v2, v3, v0, v1}, Lcom/android/server/location/CarGpsProvider;-><init>(Ljava/lang/String;Landroid/location/ILocationManager;Lcom/android/internal/location/ProviderProperties;)V
    ...
    .line 435
    .end local v13    # "lp":Lcom/android/server/location/LocationProviderInterface;
    ...
    .line 437
    .local v19, "providerPackageNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    const v2, 0x1070025
    ...
    .line 512
    .local v18, "provider":Lcom/android/server/location/GeofenceProxy;
    if-nez v18, :cond_4
    ...
    .end local v14    # "networkProvider":Lcom/android/server/location/LocationProviderProxy;
    .end local v16    # "pkgs":[Ljava/lang/String;
    .end local v18    # "provider":Lcom/android/server/location/GeofenceProxy;
    .end local v19    # "providerPackageNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v20    # "resources":Landroid/content/res/Resources;
    .restart local v13    # "lp":Lcom/android/server/location/LocationProviderInterface;
    .restart local v17    # "properties":Lcom/android/internal/location/ProviderProperties;
    :cond_5
    const-string v2, "LocationManagerService_CarGps"

    const-string v3, "loadProvidersLocked: properties is null"
    ...
    const-string v3, "loadProvidersLocked: lp is null"
    ...
    .line 459
    .end local v13    # "lp":Lcom/android/server/location/LocationProviderInterface;
    .restart local v14    # "networkProvider":Lcom/android/server/location/LocationProviderProxy;
    .restart local v16    # "pkgs":[Ljava/lang/String;
    .restart local v19    # "providerPackageNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
...
.method private removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    .line 1778
    iget-boolean v1, p1, Lcom/android/server/LocationManagerService$Receiver;->isSuperApp:Z

    .line 1781
    .local v1, "forceupdate":Z
    iget-object v7, p0, Lcom/android/server/LocationManagerService;->mReceivers:Ljava/util/HashMap;

    iget-object v8, p1, Lcom/android/server/LocationManagerService$Receiver;->mKey:Ljava/lang/Object;
    ...
    invoke-interface {v7}, Landroid/location/ILocationListener;->asBinder()Landroid/os/IBinder;

    move-result-object v7

    const/4 v8, 0x0

    invoke-interface {v7, p1, v8}, Landroid/os/IBinder;->unlinkToDeath(Landroid/os/IBinder$DeathRecipient;I)Z
    :try_end_0
    ...
    .line 1792
    :cond_0
    invoke-virtual {p1, v10}, Lcom/android/server/LocationManagerService$Receiver;->updateMonitoring(Z)V
    ...
    .line 1796
    .local v5, "providers":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    iget-object v3, p1, Lcom/android/server/LocationManagerService$Receiver;->mUpdateRecords:Ljava/util/HashMap;

    .line 1797
    .local v3, "oldRecords":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    if-eqz v3, :cond_2
    ...
    invoke-virtual {v6, v10}, Lcom/android/server/LocationManagerService$UpdateRecord;->disposeLocked(Z)V

    goto :goto_1

    .line 1784
    .end local v2    # "i$":Ljava/util/Iterator;
    .end local v3    # "oldRecords":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    .end local v5    # "providers":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    ...
    const-string v8, "unlinkToDeath failed"
    ...
    .restart local v3    # "oldRecords":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Lcom/android/server/LocationManagerService$UpdateRecord;>;"
    .restart local v5    # "providers":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    :cond_1
    ...
    invoke-direct {p0, v4}, Lcom/android/server/LocationManagerService;->isUsedBySuperApp(Ljava/lang/String;)Z
    ...
    .line 1812
    :cond_4
    invoke-direct {p0, v4}, Lcom/android/server/LocationManagerService;->applyRequirementsForSuperAppLocked(Ljava/lang/String;)V
...
.method requestLocationUpdatesLocked(Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;IILjava/lang/String;)V
    ...
    iget-boolean v5, p2, Lcom/android/server/LocationManagerService$Receiver;->isSuperApp:Z
    ...
    .line 1735
    invoke-direct {p0, v1}, Lcom/android/server/LocationManagerService;->applyRequirementsForSuperAppLocked(Ljava/lang/String;)V
...
.method private updateProviderListenersLocked(Ljava/lang/String;ZI)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/LocationManagerService;->isUsedBySuperApp(Ljava/lang/String;)Z
    ...
    const-string v9, "backdoor enable for "
    ...
    .line 1393
    :cond_7
    invoke-direct {p0, p1}, Lcom/android/server/LocationManagerService;->applyRequirementsForSuperAppLocked(Ljava/lang/String;)V
...
.method private updateProvidersLocked()V
    ...
    .line 1246
    .local v3, "changesMade":Z
    invoke-direct {p0}, Lcom/android/server/LocationManagerService;->checkSuperMode()Z

    move-result v6

    .line 1247
    .local v6, "inSuperMode":Z
    if-eqz v6, :cond_0

    .line 1248
    const-string v11, "LocationManagerService"

    const-string v12, "updateProvidersLocked: Blackdog runs"
    ...
    .line 1255
    .local v2, "changePrivacyLock":Z
    iget-object v11, p0, Lcom/android/server/LocationManagerService;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v11}, Lcom/android/server/LocationManagerService;->isUsedBySuperApp(Ljava/lang/String;)Z
    ...
    .line 1263
    :cond_1
    iget v11, p0, Lcom/android/server/LocationManagerService;->mPrivacyLock:I
    ...
    const-string v12, "##### updateProvidersLocked #####: enable_lock: 0 (Enable)"
    ...
    const-string v11, "enable_lock"

    iget v12, p0, Lcom/android/server/LocationManagerService;->mPrivacyLock:I
    ...
    const-string v12, "set_privacy_lock"

    invoke-virtual {p0, v11, v12, v4}, Lcom/android/server/LocationManagerService;->sendExtraCommand(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Z

    .line 1285
    .end local v4    # "extra":Landroid/os/Bundle;
    :cond_3
    iget-object v11, p0, Lcom/android/server/LocationManagerService;->mCarGpsProvider:Lcom/android/server/location/CarGpsProvider;

    if-eqz v11, :cond_4

    iget-object v11, p0, Lcom/android/server/LocationManagerService;->mCarGpsProvider:Lcom/android/server/location/CarGpsProvider;

    invoke-virtual {v11}, Lcom/android/server/location/CarGpsProvider;->isHtcMode()Z
    ...
    invoke-virtual {v11}, Lcom/android/server/location/CarGpsProvider;->isUsedMock()Z
    ...
    invoke-virtual {v11}, Lcom/android/server/location/CarGpsProvider;->isEnabled()Z
    ...
    .line 1290
    const-string v11, "LocationManagerService_CarGps"

    const-string v12, "updateProvidersLocked add gps to EnabledProviders"
    ...
    .line 1292
    :try_start_0
    iget-object v11, p0, Lcom/android/server/LocationManagerService;->mEnabledProviders:Ljava/util/Set;
    ...
    .line 1293
    iget-object v11, p0, Lcom/android/server/LocationManagerService;->mDisabledProviders:Ljava/util/Set;
    ...
    :cond_4
    :goto_1
    iget-object v11, p0, Lcom/android/server/LocationManagerService;->mProviders:Ljava/util/ArrayList;
    ...
    .line 1312
    .local v9, "p":Lcom/android/server/location/LocationProviderInterface;
    invoke-interface {v9}, Lcom/android/server/location/LocationProviderInterface;->isEnabled()Z
    ...
    .line 1316
    .local v10, "shouldBeEnabled":Z
    if-nez v10, :cond_8

    if-eqz v6, :cond_8

    invoke-direct {p0, v8}, Lcom/android/server/LocationManagerService;->isUsedBySuperApp(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v8, v11, v12}, Lcom/android/server/LocationManagerService;->updateProviderListenersLocked(Ljava/lang/String;ZI)V
    ...
    .line 1269
    .end local v1    # "backdoorEnabled":Z
    .end local v5    # "i":I
    .end local v7    # "isEnabled":Z
    .end local v8    # "name":Ljava/lang/String;
    .end local v9    # "p":Lcom/android/server/location/LocationProviderInterface;
    .end local v10    # "shouldBeEnabled":Z
    :cond_6
    iget v11, p0, Lcom/android/server/LocationManagerService;->mPrivacyLock:I
    ...
    const-string v12, "##### updateProvidersLocked #####: enable_lock: 1 (Disable)"
    ...
    const-string v12, "updateProvidersLocked remove gps from EnabledProviders"
    ...
    .restart local v9    # "p":Lcom/android/server/location/LocationProviderInterface;
    .restart local v10    # "shouldBeEnabled":Z
    :cond_8
    const/4 v1, 0x0
    ...
    .line 1326
    .restart local v1    # "backdoorEnabled":Z
    :cond_9
    if-eqz v7, :cond_a
    ...
    .line 1331
    iget-object v11, p0, Lcom/android/server/LocationManagerService;->mLastLocation:Ljava/util/HashMap;

    invoke-virtual {v11}, Ljava/util/HashMap;->clear()V

    .line 1332
    iget-object v11, p0, Lcom/android/server/LocationManagerService;->mLastLocationCoarseInterval:Ljava/util/HashMap;
    ...
    const-string v13, "android.location.MODE_CHANGED"
...
.method public addCarGpsProvider(Ljava/lang/String;)V
    ...
    .prologue
    .line 2056
    const-string v3, "LocationManagerService_CarGps"
    ...
    const-string v4, "addCarGpsProvider: mGpsLocationProvider is null"
    ...
    const-string v4, "addCarGpsProvider: mCarGpsProvider is null"
    ...
    const-string v4, "addCarGpsProvider: mMockProviders is not empty"
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/location/CarGpsProvider;->useMock(Z)V

    .line 2074
    new-instance v3, Ljava/lang/SecurityException;

    const-string v4, "addCarGpsProvider: mMockProviders is not empty, we don\'t do anything"
    ...
    const-string v4, "addCarGpsProvider: forced change provider name to gps"
    ...
    const-string v5, "addCarGpsProvider: removeProvider(gps)"
    ...
    const-string v5, "addCarGpsProvider: cannot remove real gps provider"
...
.method public addGpsStatusListener(Landroid/location/IGpsStatusListener;Ljava/lang/String;)Z
    ...
    .line 1969
    const-string v6, "LocationManagerService_CarGps"

    const-string v7, "addGpsStatusListener to CarGpsProvider"
...
.method public getLastLocation(Landroid/location/LocationRequest;Ljava/lang/String;)Landroid/location/Location;
    ...
    invoke-direct {p0, p2}, Lcom/android/server/LocationManagerService;->isSuperApp(Ljava/lang/String;)Z
...
.method public notifyNema(JLjava/lang/String;)V
    ...
    .line 2187
    :cond_0
    const-string v0, "LocationManagerService_CarGps"

    const-string v1, "notifyNmea: cannot reportNmea due to mCarGpsProvider is null"
...
.method public removeCarGpsProvider(Ljava/lang/String;)V
    ...
    .prologue
    .line 2117
    const-string v4, "LocationManagerService_CarGps"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "removeCarGpsProvider: name["
    ...
    const-string v5, "removeCarGpsProvider: mGpsLocationProvider is null"
    ...
    const-string v5, "removeCarGpsProvider: mCarGpsProvider is null"
    ...
    const-string v5, "addCarGpsProvider: forced change provider name to gps"
    ...
    const-string v6, "Illegal CarGpsProvider Name: "
    ...
    const-string v7, "removeCarGpsProvider: Count of Listener:"
    ...
    invoke-direct {p0, v4, v6}, Lcom/android/server/LocationManagerService;->isAllowedByUserSettingsLocked(Ljava/lang/String;I)Z
    ...
    const-string v6, "removeCarGpsPovider: Phone GPS scenario is correct, do nothing"
    ...
    const-string v6, "removeCarGpsProvider: car gps provider is not using mock"
...
.method public removeGpsStatusListener(Landroid/location/IGpsStatusListener;)V
    ...
    const-string v3, "removeGpsStatusListener from CarGpsProvider"
...
.method public sendExtraCommand(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    const-string v3, "addCarGpsProvider"
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/LocationManagerService;->addCarGpsProvider(Ljava/lang/String;)V
    ...
    const-string v3, "removeCarGpsProvider"
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/LocationManagerService;->removeCarGpsProvider(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v3, v4}, Lcom/android/server/LocationManagerService;->notifyNema(JLjava/lang/String;)V

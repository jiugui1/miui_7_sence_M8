...
.method public addUidForwarding(Ljava/lang/String;IIZ)V
    ...
    invoke-static {v0}, Lcom/android/server/ConnectivityService;->access$6900(Lcom/android/server/ConnectivityService;)Landroid/os/INetworkManagementService;
...
.method public onStateChanged(Landroid/net/NetworkInfo;)V
    ...
    invoke-static {v0}, Lcom/android/server/ConnectivityService;->access$200(Lcom/android/server/ConnectivityService;)Lcom/android/server/ConnectivityService$InternalHandler;
...
.method public override(Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/server/ConnectivityService;->access$6300(Lcom/android/server/ConnectivityService;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/lang/String;Z)V
    ...
    invoke-static {v0}, Lcom/android/server/ConnectivityService;->access$6400(Lcom/android/server/ConnectivityService;)Ljava/lang/Object;
    ...
    invoke-static {v0, v2}, Lcom/android/server/ConnectivityService;->access$6502(Lcom/android/server/ConnectivityService;Z)Z

    .line 9199
    iget-object v0, p0, Lcom/android/server/ConnectivityService$VpnCallback;->this$0:Lcom/android/server/ConnectivityService;

    # getter for: Lcom/android/server/ConnectivityService;->mGlobalProxy:Landroid/net/ProxyProperties;
    invoke-static {v0}, Lcom/android/server/ConnectivityService;->access$6600(Lcom/android/server/ConnectivityService;)Landroid/net/ProxyProperties;
    ...
    invoke-static {v0}, Lcom/android/server/ConnectivityService;->access$6700(Lcom/android/server/ConnectivityService;)Landroid/net/ProxyProperties;
    ...
    invoke-static {v0, v2}, Lcom/android/server/ConnectivityService;->access$6800(Lcom/android/server/ConnectivityService;Landroid/net/ProxyProperties;)V
...
.method public protect(Landroid/os/ParcelFileDescriptor;)V
    ...
    # getter for: Lcom/android/server/ConnectivityService;->mNetd:Landroid/os/INetworkManagementService;
    invoke-static {v1}, Lcom/android/server/ConnectivityService;->access$6900(Lcom/android/server/ConnectivityService;)Landroid/os/INetworkManagementService;
...
.method public restore()V
    ...
    # getter for: Lcom/android/server/ConnectivityService;->mDefaultProxy:Landroid/net/ProxyProperties;
    invoke-static {v2}, Lcom/android/server/ConnectivityService;->access$6700(Lcom/android/server/ConnectivityService;)Landroid/net/ProxyProperties;

.class public final Lcom/htc/server/errorreport/ErrorReportController;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/htc/server/errorreport/ErrorReportController$SystemWatcher;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/htc/server/errorreport/ErrorReportController;->DEBUG:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/htc/server/errorreport/ErrorReportController;->mWatchers:Ljava/util/HashMap;
...
.method private showWatchers()V
    ...
    .prologue
    .line 176
    iget-object v2, p0, Lcom/htc/server/errorreport/ErrorReportController;->mWatchers:Ljava/util/HashMap;
...
.method private startObserverToWatchers(Ljava/lang/String;ILandroid/content/Context;)Z
    ...
    :try_start_0
    new-instance v2, Lcom/htc/server/errorreport/ErrorReportController$SystemWatcher;

    invoke-direct {v2, p0, p1, p2, p3}, Lcom/htc/server/errorreport/ErrorReportController$SystemWatcher;-><init>(Lcom/htc/server/errorreport/ErrorReportController;Ljava/lang/String;ILandroid/content/Context;)V
    :try_end_0
    .catch Lcom/htc/server/errorreport/ReportException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 148
    iget-object v3, p0, Lcom/htc/server/errorreport/ErrorReportController;->mWatchers:Ljava/util/HashMap;
    ...
    .line 143
    .local v0, "e":Lcom/htc/server/errorreport/ReportException;
    const-string v3, "ErrorReportController"
    ...
    .line 151
    .end local v0    # "e":Lcom/htc/server/errorreport/ReportException;
    :cond_0
    const-string v3, "ErrorReportController"
...
.method private startRecursiveObserverToWatchers(Ljava/lang/String;ILandroid/content/Context;)Z
    ...
    invoke-direct {p0, v5, p2, p3}, Lcom/htc/server/errorreport/ErrorReportController;->startObserverToWatchers(Ljava/lang/String;ILandroid/content/Context;)Z
...
.method public declared-synchronized startWatching(Landroid/content/Context;)V
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/htc/server/errorreport/ErrorReportController;->mRunning:Z
    ...
    iput-boolean v1, p0, Lcom/htc/server/errorreport/ErrorReportController;->mRunning:Z
    :try_end_0
    ...
    invoke-direct {p0, v1, v2, p1}, Lcom/htc/server/errorreport/ErrorReportController;->startObserverToWatchers(Ljava/lang/String;ILandroid/content/Context;)Z
    ...
    invoke-direct {p0, v1, v2, p1}, Lcom/htc/server/errorreport/ErrorReportController;->startRecursiveObserverToWatchers(Ljava/lang/String;ILandroid/content/Context;)Z
    :try_end_1
...
.method public declared-synchronized stopWatching()V
    ...
    :try_start_0
    iget-boolean v3, p0, Lcom/htc/server/errorreport/ErrorReportController;->mRunning:Z
    ...
    .line 164
    sget-boolean v3, Lcom/htc/server/errorreport/ErrorReportController;->DEBUG:Z
    ...
    iput-boolean v3, p0, Lcom/htc/server/errorreport/ErrorReportController;->mRunning:Z
    ...
    iget-boolean v5, p0, Lcom/htc/server/errorreport/ErrorReportController;->mRunning:Z

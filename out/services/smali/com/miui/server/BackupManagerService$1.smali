...
.method constructor <init>(Lcom/miui/server/BackupManagerService;I)V
    ...
    iput p2, p0, Lcom/miui/server/BackupManagerService$1;->val$token:I
...
.method public run()V
    ...
    :try_start_0
    iget v1, p0, Lcom/miui/server/BackupManagerService$1;->val$token:I

    const/4 v2, 0x1

    const-string v3, ""

    iget-object v4, p0, Lcom/miui/server/BackupManagerService$1;->this$0:Lcom/miui/server/BackupManagerService;

    # getter for: Lcom/miui/server/BackupManagerService;->mPwd:Ljava/lang/String;
    invoke-static {v4}, Lcom/miui/server/BackupManagerService;->access$200(Lcom/miui/server/BackupManagerService;)Ljava/lang/String;

    move-result-object v4

    new-instance v5, Lcom/miui/server/BackupManagerService$FullBackupRestoreObserver;

    iget-object v7, p0, Lcom/miui/server/BackupManagerService$1;->this$0:Lcom/miui/server/BackupManagerService;

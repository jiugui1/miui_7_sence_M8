...
.field private static final CMD_GET_SERIAL_NUMBER_WITH_CHAR_EXT:I = 0x6d8
...
.field public static final METHOD_GET_SERIAL_NUMBER_WITH_CHAR_EXT:Ljava/lang/String; = "getSimSerialNumberwithCharExt"
...
.method static synthetic access$100(Lcom/android/internal/telephony/HtcTelephonyInternal;)Lcom/android/internal/telephony/CommandsInterface;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/HtcTelephonyInternal;
...
.method static synthetic access$1000(Lcom/android/internal/telephony/HtcTelephonyInternal;Z)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/HtcTelephonyInternal;
    .param p1, "x1"    # Z
...
.method static synthetic access$200(Lcom/android/internal/telephony/HtcTelephonyInternal;)[B
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/HtcTelephonyInternal;
...
.method static synthetic access$202(Lcom/android/internal/telephony/HtcTelephonyInternal;[B)[B
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/HtcTelephonyInternal;
    .param p1, "x1"    # [B
...
.method static synthetic access$302(Lcom/android/internal/telephony/HtcTelephonyInternal;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/HtcTelephonyInternal;
    .param p1, "x1"    # I
...
.method static synthetic access$602(Lcom/android/internal/telephony/HtcTelephonyInternal;Lcom/android/internal/telephony/Phone;)Lcom/android/internal/telephony/Phone;
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/HtcTelephonyInternal;
...
.method public generalGetter(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 3372
    iget-object v12, p0, Lcom/android/internal/telephony/HtcTelephonyInternal;->mPhone:Lcom/android/internal/telephony/Phone;

    invoke-static {v12}, Lcom/android/internal/telephony/HtcRilExtendApi;->getDefault(Lcom/android/internal/telephony/Phone;)Lcom/android/internal/telephony/HtcRilExtendApi;

    move-result-object v12

    move-object/from16 v0, p2

    invoke-virtual {v12, v0}, Lcom/android/internal/telephony/HtcRilExtendApi;->rilFunctionMappingTable(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 3367
    iget-object v12, p0, Lcom/android/internal/telephony/HtcTelephonyInternal;->mContext:Landroid/content/Context;
    ...
    :cond_1
    iget-object v12, p0, Lcom/android/internal/telephony/HtcTelephonyInternal;->methodMap:Ljava/util/HashMap;
    ...
    .line 3377
    .local v6, "mapResult":Ljava/lang/Integer;
    new-instance v1, Landroid/os/Bundle;
    ...
    invoke-direct {p0, v12, v0}, Lcom/android/internal/telephony/HtcTelephonyInternal;->sendRequest(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v12}, Lcom/android/internal/telephony/Phone;->htcGetCdmaEriCallGuard()I

    move-result v11

    .line 3433
    .local v11, "roamingType":I
    const-string v12, "roamingType"

    invoke-virtual {v1, v12, v11}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    .line 3434
    sget-boolean v12, Lcom/android/internal/telephony/HtcTelephonyInternal;->DBG:Z

    if-eqz v12, :cond_0

    const-string v12, "HtcTelephonyInternal"

    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string v14, "CMD_HTC_GET_CDMA_ERI_CALL_GUARD:"
    ...
    :try_start_1
    const-string v12, "com.android.internal.telephony.dataconnection.DcTracker"
    ...
    .line 3446
    .local v9, "mmdt":Ljava/lang/Object;
    if-eqz v2, :cond_2
    ...
    iget-object v9, v12, Lcom/android/internal/telephony/PhoneBase;->mDcTracker:Lcom/android/internal/telephony/dataconnection/DcTracker;

    .line 3449
    .end local v9    # "mmdt":Ljava/lang/Object;
    :cond_2
    if-eqz v9, :cond_3
    ...
    .line 3452
    .local v7, "methodReset":Ljava/lang/reflect/Method;
    :try_start_2
    const-string v13, "onResetToDefaultforApnSetting"
    ...
    .line 3458
    .end local v7    # "methodReset":Ljava/lang/reflect/Method;
    :cond_3
    :goto_3
    new-instance v1, Landroid/os/Bundle;
    ...
    .line 3454
    .restart local v1    # "bundleResult":Landroid/os/Bundle;
    .restart local v7    # "methodReset":Ljava/lang/reflect/Method;
    :catch_1
    move-exception v3
    ...
    const-string v14, "onResetToDefaultforApnSetting Fail: "
    ...
    .line 3466
    .local v8, "method_radioTech":Ljava/lang/reflect/Method;
    :try_start_3
    const-class v13, Landroid/telephony/ServiceState;

    const-string v14, "getRilRadioTechnology"
    ...
    const-string v13, "getRilRadioTechnology() existed."
    ...
    const-string v14, "getRilDataRadioTechnology"
    ...
    const-string v13, "getRilDataRadioTechnology() existed."
    ...
    .line 3484
    .local v10, "rilRadioTech":I
    const-string v12, "getRilRadioTechnology"
    ...
    const-string v14, "CMD_GET_RIL_RADIO_TECHNOLOGY:"
    ...
    const-string v13, "CMD_GET_RIL_RADIO_TECHNOLOGY exception"
    ...
    .line 3495
    .end local v3    # "e":Ljava/lang/Exception;
    .end local v8    # "method_radioTech":Ljava/lang/reflect/Method;
    :sswitch_4
    iget-object v12, p0, Lcom/android/internal/telephony/HtcTelephonyInternal;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v12}, Lcom/android/internal/telephony/CallManager;->isImsPhoneIdle()Z

    move-result v5

    .line 3497
    .local v5, "isImsPhoneIdle":Z
    const-string v12, "isImsPhoneIdle"

    invoke-virtual {v1, v12, v5}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V
    ...
    const-string v14, "CMD_IS_IMS_PHONE_IDLE:"
    ...
    invoke-direct {p0, v12}, Lcom/android/internal/telephony/HtcTelephonyInternal;->isAutoNetworkSelectionMode(I)Z
    ...
    const-string v14, "CMD_GET_NETWORK_SELECTION_MODE = "
    ...
    .line 3509
    :cond_7
    const-string v12, "isAutoNetworkSelectionMode"
    ...
    .line 3514
    .end local v4    # "isAutoSelection":Z
    :sswitch_6
    iget-object v12, p0, Lcom/android/internal/telephony/HtcTelephonyInternal;->mContext:Landroid/content/Context;
    ...
    .line 3515
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/HtcTelephonyInternal;->internalGetMobileDataOverallState(Landroid/os/Bundle;)V
    ...
    iget-object v13, p0, Lcom/android/internal/telephony/HtcTelephonyInternal;->mContext:Landroid/content/Context;

    invoke-static {v13}, Lcom/android/internal/telephony/HtcBuildUtils;->isNFCEnabled(Landroid/content/Context;)Z
...
.method public generalSetter(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-interface {v3, v6}, Lcom/android/internal/telephony/CommandsInterface;->sendUserTrialFeedback(Landroid/os/Message;)V
    ...
    invoke-interface {v3, v1, v6}, Lcom/android/internal/telephony/CommandsInterface;->requestPassHotSpotState(ILandroid/os/Message;)V

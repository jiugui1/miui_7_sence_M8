...
.method public checkHyperlinkClicked()V
    ...
    invoke-static {v1, v2}, Landroid/webkit/WebViewClassic;->access$9802(Landroid/webkit/WebViewClassic;Z)Z
    ...
    invoke-static {v1}, Landroid/webkit/WebViewClassic;->access$9900(Landroid/webkit/WebViewClassic;)Z
    ...
    iget-boolean v1, v1, Landroid/webkit/WebViewClassic;->mIsEditingText:Z
    ...
    invoke-virtual {v1}, Landroid/webkit/WebViewClassic;->singleTapSpellCheck()V
...
.method public clearPreviousHitTest()V
    ...
    # setter for: Landroid/webkit/WebViewClassic;->mIsClickOnHyperlinkChecked:Z
    invoke-static {v0, v1}, Landroid/webkit/WebViewClassic;->access$9802(Landroid/webkit/WebViewClassic;Z)Z
...
.method public dispatchUiEvent(Landroid/view/MotionEvent;II)V
    ...
    invoke-static {v0, p1, p2, p3}, Landroid/webkit/WebViewClassic;->access$9400(Landroid/webkit/WebViewClassic;Landroid/view/MotionEvent;II)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$2200(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewCore;
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$3500(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewDatabaseClassic;
    ...
    const-string v56, "username"

    invoke-virtual/range {v55 .. v56}, Landroid/os/Bundle;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$4202(Landroid/webkit/WebViewClassic;Z)Z
    ...
    # getter for: Landroid/webkit/WebViewClassic;->mAutoScrollY:I
    invoke-static/range {v55 .. v55}, Landroid/webkit/WebViewClassic;->access$4100(Landroid/webkit/WebViewClassic;)I
    ...
    invoke-static {v3, v8, v0, v1, v2}, Landroid/webkit/WebViewClassic;->access$4400(Landroid/webkit/WebViewClassic;IIZI)Z

    .line 11233
    :goto_1
    const/16 v3, 0xb

    const-wide/16 v55, 0x10
    ...
    # getter for: Landroid/webkit/WebViewClassic;->mAutoScrollX:I
    invoke-static/range {v55 .. v55}, Landroid/webkit/WebViewClassic;->access$4000(Landroid/webkit/WebViewClassic;)I
    ...
    # getter for: Landroid/webkit/WebViewClassic;->mScrollingLayerRect:Landroid/graphics/Rect;
    invoke-static/range {v55 .. v55}, Landroid/webkit/WebViewClassic;->access$4500(Landroid/webkit/WebViewClassic;)Landroid/graphics/Rect;
    ...
    # getter for: Landroid/webkit/WebViewClassic;->mAutoScrollY:I
    invoke-static/range {v56 .. v56}, Landroid/webkit/WebViewClassic;->access$4100(Landroid/webkit/WebViewClassic;)I
    ...
    invoke-static {v3, v8, v0}, Landroid/webkit/WebViewClassic;->access$4600(Landroid/webkit/WebViewClassic;II)V
    ...
    invoke-static {v8, v0, v1, v3}, Landroid/webkit/WebViewClassic;->access$4700(Landroid/webkit/WebViewClassic;IIZ)V
    ...
    .line 11254
    .end local v37    # "p":Landroid/graphics/Point;
    :sswitch_4
    move-object/from16 v0, p1
    ...
    check-cast v48, Landroid/webkit/WebViewCore$ViewState;

    .line 11256
    .local v48, "viewState":Landroid/webkit/WebViewCore$ViewState;
    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/webkit/WebViewClassic$PrivateHandler;->this$0:Landroid/webkit/WebViewClassic;

    # getter for: Landroid/webkit/WebViewClassic;->mZoomManager:Landroid/webkit/ZoomManager;
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$4800(Landroid/webkit/WebViewClassic;)Landroid/webkit/ZoomManager;
    ...
    .line 11260
    .end local v48    # "viewState":Landroid/webkit/WebViewCore$ViewState;
    :sswitch_5
    move-object/from16 v0, p1
    ...
    invoke-virtual {v3, v13}, Landroid/webkit/ZoomManager;->updateDefaultZoomDensity(F)V
    ...
    invoke-virtual {v3, v0, v8}, Landroid/webkit/WebViewClassic;->setNewPicture(Landroid/webkit/WebViewCore$DrawData;Z)V
    ...
    invoke-static {v3, v8, v0, v1}, Landroid/webkit/WebViewClassic;->access$4900(Landroid/webkit/WebViewClassic;ILjava/lang/String;Z)V
    ...
    .line 11285
    .restart local v37    # "p":Landroid/graphics/Point;
    move-object/from16 v0, v37
    ...
    .line 11288
    # getter for: Landroid/webkit/WebViewClassic;->HTC_DEBUG:Z
    invoke-static {}, Landroid/webkit/WebViewClassic;->access$5100()Z
    ...
    const-string v55, "fling points per sec set to "
    ...
    invoke-static/range {v55 .. v55}, Landroid/webkit/WebViewClassic;->access$5000(Landroid/webkit/WebViewClassic;)I
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$5200(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewCore$DrawData;
    ...
    # getter for: Landroid/webkit/WebViewClassic;->mDelaySetPicture:Landroid/webkit/WebViewCore$DrawData;
    invoke-static {v8}, Landroid/webkit/WebViewClassic;->access$5200(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewCore$DrawData;
    ...
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$5202(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewCore$DrawData;)Landroid/webkit/WebViewCore$DrawData;
    ...
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$5500(IZ)V
    ...
    # getter for: Landroid/webkit/WebViewClassic;->mWebViewCore:Landroid/webkit/WebViewCore;
    invoke-static/range {v55 .. v55}, Landroid/webkit/WebViewClassic;->access$2200(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewCore;

    move-result-object v55

    invoke-virtual/range {v55 .. v55}, Landroid/webkit/WebViewCore;->getInputDispatcherCallbacks()Landroid/webkit/WebViewInputDispatcher$WebKitCallbacks;
    ...
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$5602(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewInputDispatcher;)Landroid/webkit/WebViewInputDispatcher;
    ...
    iget-object v3, v3, Landroid/webkit/WebViewClassic;->mInputConnection:Landroid/webkit/WebViewClassic$WVInputConnection;
    ...
    invoke-virtual {v3, v6}, Landroid/webkit/WebViewClassic$WVInputConnection;->setTextAndKeepSelection(Ljava/lang/CharSequence;)V
    ...
    invoke-static {v8, v0, v1, v3}, Landroid/webkit/WebViewClassic;->access$5800(Landroid/webkit/WebViewClassic;IILandroid/webkit/WebViewCore$TextSelectionData;)V
    ...
    invoke-virtual {v3, v14}, Landroid/webkit/WebView;->focusSearch(I)Landroid/view/View;
    ...
    invoke-static {v3, v8, v0, v1, v2}, Landroid/webkit/WebViewClassic;->access$5900(Landroid/webkit/WebViewClassic;IIII)V
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$5600(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewInputDispatcher;
    ...
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$6200(Landroid/webkit/WebViewClassic;Z)V
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$6400(Landroid/webkit/WebViewClassic;)Landroid/webkit/HTML5VideoViewProxy;
    ...
    .line 11400
    .local v46, "view":Landroid/view/View;
    move-object/from16 v0, p1
    ...
    .end local v46    # "view":Landroid/view/View;
    :sswitch_16
    move-object/from16 v0, p0
    ...
    # getter for: Landroid/webkit/WebViewClassic;->mZoomManager:Landroid/webkit/ZoomManager;
    invoke-static {v8}, Landroid/webkit/WebViewClassic;->access$4800(Landroid/webkit/WebViewClassic;)Landroid/webkit/ZoomManager;
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$6700(Landroid/webkit/WebViewClassic;)F
    ...
    # getter for: Landroid/webkit/WebViewClassic;->mShowRectScale:F
    invoke-static {v8}, Landroid/webkit/WebViewClassic;->access$6700(Landroid/webkit/WebViewClassic;)F
    ...
    .line 11429
    .local v49, "viewWidth":I
    move/from16 v0, v27

    int-to-float v3, v0

    iget v8, v12, Landroid/webkit/WebViewCore$ShowRectData;->mXPercentInDoc:F
    ...
    iget v8, v12, Landroid/webkit/WebViewCore$ShowRectData;->mXPercentInView:F
    ...
    .line 11440
    :cond_13
    iget v3, v12, Landroid/webkit/WebViewCore$ShowRectData;->mFocusedNode:I
    ...
    .line 11454
    .local v47, "viewHeight":I
    move/from16 v0, v44

    int-to-float v3, v0

    iget v8, v12, Landroid/webkit/WebViewCore$ShowRectData;->mYPercentInDoc:F
    ...
    iget v8, v12, Landroid/webkit/WebViewCore$ShowRectData;->mYPercentInView:F
    ...
    invoke-static {v3, v0}, Landroid/webkit/WebViewClassic;->access$6902(Landroid/webkit/WebViewClassic;I)I
    ...
    invoke-static {v3, v0}, Landroid/webkit/WebViewClassic;->access$7002(Landroid/webkit/WebViewClassic;I)I
    ...
    iget v8, v12, Landroid/webkit/WebViewCore$ShowRectData;->mDelta:F

    # setter for: Landroid/webkit/WebViewClassic;->mScrollYDelta:F
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$7102(Landroid/webkit/WebViewClassic;F)F
    ...
    .restart local v44    # "top":I
    .restart local v47    # "viewHeight":I
    ...
    # getter for: Landroid/webkit/WebViewClassic;->mFieldPointer:I
    invoke-static/range {v55 .. v55}, Landroid/webkit/WebViewClassic;->access$100(Landroid/webkit/WebViewClassic;)I
    ...
    check-cast v41, Landroid/webkit/WebViewClassic$SaveWebArchiveMessage;

    .line 11507
    .local v41, "saveMessage":Landroid/webkit/WebViewClassic$SaveWebArchiveMessage;
    ...
    .line 11513
    .end local v41    # "saveMessage":Landroid/webkit/WebViewClassic$SaveWebArchiveMessage;
    :sswitch_1d
    move-object/from16 v0, p0
    ...
    invoke-static {v8, v3}, Landroid/webkit/WebViewClassic;->access$3402(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewCore$AutoFillData;)Landroid/webkit/WebViewCore$AutoFillData;
    ...
    invoke-static {v8}, Landroid/webkit/WebViewClassic;->access$3400(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewCore$AutoFillData;
    ...
    invoke-virtual {v3, v8}, Landroid/webkit/WebViewClassic$WVInputConnection;->setAutoFillable(I)V
    ...
    .line 11523
    .local v38, "pastEntries":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    move-object/from16 v0, p0
    ...
    # getter for: Landroid/webkit/WebViewClassic;->mContext:Landroid/content/Context;
    invoke-static/range {v55 .. v55}, Landroid/webkit/WebViewClassic;->access$1300(Landroid/webkit/WebViewClassic;)Landroid/content/Context;
    ...
    .line 11532
    .end local v38    # "pastEntries":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    :sswitch_1f
    move-object/from16 v0, p1
    ...
    aget-object v55, v10, v55

    move-object/from16 v0, v55

    # invokes: Landroid/webkit/WebViewClassic;->copyToClipboard(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3}, Landroid/webkit/WebViewClassic;->isHtcSupportedIME()Z

    move-result v11

    .line 11541
    .local v11, "currentIsHtcSupportedIME":Z
    if-eqz v11, :cond_19
    ...
    new-instance v8, Landroid/webkit/WebViewClassic$HtcWebViewInputConnection;
    ...
    invoke-direct {v8, v0}, Landroid/webkit/WebViewClassic$HtcWebViewInputConnection;-><init>(Landroid/webkit/WebViewClassic;)V

    iput-object v8, v3, Landroid/webkit/WebViewClassic;->mInputConnection:Landroid/webkit/WebViewClassic$WVInputConnection;
    ...
    new-instance v8, Landroid/webkit/AutoCompletePopup;
    ...
    invoke-direct {v8, v0, v1}, Landroid/webkit/AutoCompletePopup;-><init>(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewClassic$WVInputConnection;)V

    # setter for: Landroid/webkit/WebViewClassic;->mAutoCompletePopup:Landroid/webkit/AutoCompletePopup;
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$602(Landroid/webkit/WebViewClassic;Landroid/webkit/AutoCompletePopup;)Landroid/webkit/AutoCompletePopup;
    ...
    check-cast v25, Landroid/webkit/WebViewCore$TextFieldInitData;

    .line 11551
    .local v25, "initData":Landroid/webkit/WebViewCore$TextFieldInitData;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v3}, Landroid/webkit/WebViewClassic$WVInputConnection;->getInputType()I
    ...
    invoke-virtual {v3}, Landroid/webkit/WebViewClassic$WVInputConnection;->getImeOptions()I

    move-result v34

    .line 11555
    .local v34, "oldOption":I
    move-object/from16 v0, p0
    ...
    invoke-virtual {v3, v0}, Landroid/webkit/WebViewClassic$WVInputConnection;->initEditorInfo(Landroid/webkit/WebViewCore$TextFieldInitData;)V
    ...
    invoke-virtual {v3}, Landroid/webkit/WebViewClassic$WVInputConnection;->restartInput()V
    ...
    .line 11561
    .end local v51    # "willRestartInput":Z
    :cond_1d
    const/16 v51, 0x0
    ...
    .line 11577
    .restart local v51    # "willRestartInput":Z
    :cond_1e
    move-object/from16 v0, p0
    ...
    invoke-virtual {v3, v8}, Landroid/webkit/WebViewClassic$WVInputConnection;->setTextAndKeepSelection(Ljava/lang/CharSequence;)V

    goto :goto_8

    .line 11590
    .end local v11    # "currentIsHtcSupportedIME":Z
    .end local v25    # "initData":Landroid/webkit/WebViewCore$TextFieldInitData;
    .end local v34    # "oldOption":I
    .end local v35    # "oldType":I
    .end local v51    # "willRestartInput":Z
    :sswitch_21
    move-object/from16 v0, p1
    ...
    invoke-virtual {v3, v0}, Landroid/webkit/WebViewClassic;->doSelByIndxBatch(I)V
    ...
    check-cast v40, Landroid/webkit/WebViewCore$FindAllRequest;

    .line 11610
    .local v40, "request":Landroid/webkit/WebViewCore$FindAllRequest;
    if-nez v40, :cond_1f
    ...
    .line 11631
    .end local v40    # "request":Landroid/webkit/WebViewCore$FindAllRequest;
    :sswitch_24
    move-object/from16 v0, p0
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$1200(Landroid/webkit/WebViewClassic;)Z
    ...
    invoke-virtual {v3, v8}, Landroid/webkit/QuickActionsHelper;->setCallback(Landroid/view/ActionMode$Callback;)V
    ...
    invoke-virtual {v3}, Landroid/webkit/WebViewClassic;->isKikinEnable()Z
    ...
    check-cast v32, Landroid/webkit/WebViewCore$ModifySelectionData;

    .line 11719
    .local v32, "msd":Landroid/webkit/WebViewCore$ModifySelectionData;
    move-object/from16 v0, p0
    ...
    # invokes: Landroid/webkit/WebViewClassic;->modifySelection(Ljava/util/List;ZZZ)V
    invoke-static {v3, v8, v0, v1, v2}, Landroid/webkit/WebViewClassic;->access$9000(Landroid/webkit/WebViewClassic;Ljava/util/List;ZZZ)V

    goto/16 :goto_0

    .line 11725
    .end local v32    # "msd":Landroid/webkit/WebViewCore$ModifySelectionData;
    :sswitch_32
    move-object/from16 v0, p0
    ...
    check-cast v43, Lcom/kikin/selection/Selection;

    .line 11727
    .local v43, "selectionExtract":Lcom/kikin/selection/Selection;
    move-object/from16 v0, p0
    ...
    # invokes: Landroid/webkit/WebViewClassic;->onSelectionContextExtracted(Lcom/kikin/selection/Selection;)V
    invoke-static {v3, v0}, Landroid/webkit/WebViewClassic;->access$9100(Landroid/webkit/WebViewClassic;Lcom/kikin/selection/Selection;)V

    goto/16 :goto_0

    .line 11731
    .end local v43    # "selectionExtract":Lcom/kikin/selection/Selection;
    :sswitch_33
    move-object/from16 v0, p0
    ...
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$9202(Landroid/webkit/WebViewClassic;Z)Z
    ...
    instance-of v3, v3, Landroid/webkit/WebViewClassic$HtcWebViewInputConnection;
    ...
    check-cast v3, Landroid/webkit/WebViewClassic$HtcWebViewInputConnection;
    ...
    invoke-virtual {v3, v8, v0}, Landroid/webkit/WebViewClassic$HtcWebViewInputConnection;->htc_setComposingText(Ljava/lang/CharSequence;I)Z
    ...
    invoke-virtual {v3, v8, v0}, Landroid/webkit/WebViewClassic$HtcWebViewInputConnection;->htc_commitText(Ljava/lang/CharSequence;I)Z
    ...
    check-cast v22, Landroid/webkit/WebViewClassic$HtcWebViewInputConnection;

    .line 11758
    .local v22, "ic":Landroid/webkit/WebViewClassic$HtcWebViewInputConnection;
    if-eqz v22, :cond_25

    .line 11759
    invoke-virtual/range {v22 .. v22}, Landroid/webkit/WebViewClassic$HtcWebViewInputConnection;->htc_finishComposing()Z
    ...
    .line 11766
    .end local v22    # "ic":Landroid/webkit/WebViewClassic$HtcWebViewInputConnection;
    :sswitch_38
    move-object/from16 v0, p0
    ...
    # invokes: Landroid/webkit/WebViewClassic;->nativeSetTextSelection(II)V
    invoke-static {v3, v8}, Landroid/webkit/WebViewClassic;->access$9300(II)V
    ...
    invoke-virtual {v3, v8}, Landroid/webkit/WebViewClassic$HtcWebViewInputConnection;->updateCursor([I)V
    ...
    iget-object v3, v3, Landroid/webkit/WebViewClassic;->mWebViewSpellCheckHelper:Landroid/webkit/WebViewSpellCheckHelper;
    ...
    new-instance v8, Landroid/webkit/WebViewSpellCheckHelper;
    ...
    # getter for: Landroid/webkit/WebViewClassic;->mWebViewCore:Landroid/webkit/WebViewCore;
    invoke-static/range {v56 .. v56}, Landroid/webkit/WebViewClassic;->access$2200(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewCore;
    ...
    invoke-direct {v8, v0, v1}, Landroid/webkit/WebViewSpellCheckHelper;-><init>(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewCore;)V

    iput-object v8, v3, Landroid/webkit/WebViewClassic;->mWebViewSpellCheckHelper:Landroid/webkit/WebViewSpellCheckHelper;
    ...
    invoke-virtual {v3, v0}, Landroid/webkit/WebViewSpellCheckHelper;->setSpellCheckEnabled(Z)V
    ...
    .line 11814
    .local v42, "scrollPoint":Landroid/graphics/Point;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v3, v8, v0}, Landroid/webkit/WebViewClassic;->shiftAfterZoom(II)V
...
.method public shouldInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v3}, Landroid/webkit/WebViewClassic;->access$9500(Landroid/webkit/WebViewClassic;)Landroid/graphics/Rect;
...
.method public showTapHighlight(Z)V
    ...
    invoke-static {v0}, Landroid/webkit/WebViewClassic;->access$9700(Landroid/webkit/WebViewClassic;)Z
    ...
    invoke-static {v0, p1}, Landroid/webkit/WebViewClassic;->access$9702(Landroid/webkit/WebViewClassic;Z)Z

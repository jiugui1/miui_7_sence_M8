...
.method public onConnected(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, Landroid/media/MediaPluginDLNA;->access$1302(Landroid/media/MediaPluginDLNA;Ljava/lang/String;)Ljava/lang/String;

    .line 285
    iget-object v0, p0, Landroid/media/MediaPluginDLNA$RendererListener;->this$0:Landroid/media/MediaPluginDLNA;

    # getter for: Landroid/media/MediaPluginDLNA;->eventHandler:Landroid/media/MediaPluginDLNA$EventHandler;
    invoke-static {v0}, Landroid/media/MediaPluginDLNA;->access$1400(Landroid/media/MediaPluginDLNA;)Landroid/media/MediaPluginDLNA$EventHandler;
    ...
    # getter for: Landroid/media/MediaPluginDLNA;->eventHandler:Landroid/media/MediaPluginDLNA$EventHandler;
    invoke-static {v1}, Landroid/media/MediaPluginDLNA;->access$1400(Landroid/media/MediaPluginDLNA;)Landroid/media/MediaPluginDLNA$EventHandler;

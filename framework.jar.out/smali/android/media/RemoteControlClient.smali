...
# static fields
.field public static final CHANGE_ALL_METADATA:I = 0x0

.field public static final CHANGE_ARTWORK:I = 0x2

.field public static final CHANGE_CURRENT_CLIENT_ID:I = 0x5

.field public static final CHANGE_METADATA:I = 0x1

.field public static final CHANGE_PLAYBACK:I = 0x3

.field public static final CHANGE_TRANSPORT_CONTROL_FLAGS:I = 0x4
...
.method private notifyRccEventChange(I)V
    .locals 8
    .param p1, "change"    # I
    ...
    :try_start_0
    invoke-interface {v4}, Landroid/media/IAudioService;->getRccEventDispatcher()Landroid/media/IRccEventDispatcher;

    move-result-object v2

    .line 1812
    .local v2, "dispatcher":Landroid/media/IRccEventDispatcher;
    if-eqz v2, :cond_0
    ...
    .line 1816
    .local v1, "arg2":Landroid/os/Bundle;
    packed-switch p1, :pswitch_data_0

    .line 1847
    .end local v0    # "arg1":I
    .end local v1    # "arg2":Landroid/os/Bundle;
    .end local v2    # "dispatcher":Landroid/media/IRccEventDispatcher;
    :cond_0
    :goto_0
    return-void
    ...
    .restart local v1    # "arg2":Landroid/os/Bundle;
    .restart local v2    # "dispatcher":Landroid/media/IRccEventDispatcher;
    :pswitch_0
    new-instance v1, Landroid/os/Bundle;
    ...
    iget-object v6, p0, Landroid/media/RemoteControlClient;->mOriginalArtwork:Landroid/graphics/Bitmap;

    invoke-virtual {v1, v5, v6}, Landroid/os/Bundle;->putParcelable(Ljava/lang/String;Landroid/os/Parcelable;)V

    .line 1841
    :goto_1
    const-string v5, "RemoteControlClient"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "[RccEvent]["
    ...
    const-string v7, "]notifyRccEventChange change="
    ...
    .line 1842
    invoke-interface {v2, p1, v0, v1}, Landroid/media/IRccEventDispatcher;->dispatchRccEventChange(IILandroid/os/Bundle;)V
    :try_end_0
    ...
    const-string v6, "[RccEvent]Dead object in notifyRccEventChange"
    ...
    invoke-virtual {p0}, Landroid/media/RemoteControlClient;->getPackageName()Ljava/lang/String;
...
.method private sendArtwork_syncCacheLock(Landroid/media/IRemoteControlDisplay;II)V
    ...
    const-string v3, "[RccEvent]mArtworkChanged"
    ...
    invoke-direct {p0, v2}, Landroid/media/RemoteControlClient;->notifyRccEventChange(I)V
...
.method private sendMetadataWithArtwork_syncCacheLock(Landroid/media/IRemoteControlDisplay;II)V
    ...
    const-string v5, "[RccEvent]mMetadataChanged & mArtworkChanged"
    ...
    invoke-direct {p0, v4}, Landroid/media/RemoteControlClient;->notifyRccEventChange(I)V
...
.method private sendMetadata_syncCacheLock(Landroid/media/IRemoteControlDisplay;)V
    ...
    const-string v4, "[RccEvent]mMetadataChanged"
    ...
    invoke-direct {p0, v3}, Landroid/media/RemoteControlClient;->notifyRccEventChange(I)V
...
.method private sendPlaybackState_syncCacheLock(Landroid/media/IRemoteControlDisplay;)V
    ...
    const-string v1, "[RccEvent]setPlaybackState"
    ...
    invoke-direct {p0, v0}, Landroid/media/RemoteControlClient;->notifyRccEventChange(I)V
...
.method private sendTransportControlInfo_syncCacheLock(Landroid/media/IRemoteControlDisplay;)V
    ...
    const-string v4, "[RccEvent]setTransportControlFlags"
...
.method private setPlaybackStateInt(IJFZ)V
    ...
    iget-wide v5, p0, Landroid/media/RemoteControlClient;->mPlaybackStateChangeTimeMs:J

    sub-long/2addr v3, v5

    long-to-float v1, v3

    iget v3, p0, Landroid/media/RemoteControlClient;->mPlaybackSpeed:F
    ...
    iput-wide v3, p0, Landroid/media/RemoteControlClient;->mPlaybackPositionMs:J
    ...
    iput-wide v3, p0, Landroid/media/RemoteControlClient;->mPlaybackStateChangeTimeMs:J

    .line 634
    const/4 v1, 0x0

    invoke-direct {p0, v1}, Landroid/media/RemoteControlClient;->sendPlaybackState_syncCacheLock(Landroid/media/IRemoteControlDisplay;)V
...
.method public getPackageName()Ljava/lang/String;
    ...
    .prologue
    .line 1099
    iget-object v0, p0, Landroid/media/RemoteControlClient;->mPackageName:Ljava/lang/String;
...
.method public setPackageName(Ljava/lang/String;)V
    ...
    .prologue
    .line 1095
    iput-object p1, p0, Landroid/media/RemoteControlClient;->mPackageName:Ljava/lang/String;

...
# static fields
.field protected static final TAG:Ljava/lang/String; = "MediaImageItem"
...
.field protected mDecodedFilename:Ljava/lang/String;

.field protected mDurationMs:J

.field protected mExportHeight:I

.field protected mExportWidth:I

.field protected mFileName:Ljava/lang/String;

.field protected mGeneratedClipHeight:I

.field protected mGeneratedClipWidth:I
...
.field protected mScaledFilename:Ljava/lang/String;
...
.method public constructor <init>(Landroid/media/videoeditor/VideoEditor;Ljava/lang/String;Ljava/lang/String;JI)V
    ...
    invoke-virtual {v0, v1, v8, v7}, Landroid/media/videoeditor/MediaImageItem;->scaleImage(Ljava/lang/String;II)Landroid/graphics/Bitmap;
...
.method public constructor <init>(Landroid/media/videoeditor/VideoEditor;Ljava/lang/String;Ljava/lang/String;JILjava/lang/Object;)V
    .locals 6
    .param p1, "editor"    # Landroid/media/videoeditor/VideoEditor;
    .param p2, "mediaItemId"    # Ljava/lang/String;
    .param p3, "filename"    # Ljava/lang/String;
    .param p4, "durationMs"    # J
    .param p6, "renderingMode"    # I
    .param p7, "userObject"    # Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
    ...
    invoke-direct/range {v0 .. v5}, Landroid/media/videoeditor/MediaItem;-><init>(Landroid/media/videoeditor/VideoEditor;Ljava/lang/String;Ljava/lang/String;I[Ljava/lang/Object;)V

    const-string v0, "MediaImageItem"

    const-string v1, "[MTest09] MediaImageItem New!!!"
...
# virtual methods
.method protected adjustEffects()Ljava/util/List;
    .locals 12
...
.method protected adjustOverlays()Ljava/util/List;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public generateKenburnsClip(Landroid/media/videoeditor/EffectKenBurns;)Landroid/media/videoeditor/MediaArtistNativeHelper$ClipSettings;
    .locals 6
    ...
    invoke-virtual {p0, p1}, Landroid/media/videoeditor/MediaImageItem;->getKenBurns(Landroid/media/videoeditor/EffectKenBurns;)Landroid/media/videoeditor/MediaArtistNativeHelper$ClipSettings;
    ...
    invoke-virtual {p0, v3, v4}, Landroid/media/videoeditor/MediaImageItem;->getWidthByAspectRatioAndHeight(II)I
...
.method public getDecodedImageFileName()Ljava/lang/String;
    .locals 1
...
.method public getExportHeight()I
    ...
    .prologue
    iget v0, p0, Landroid/media/videoeditor/MediaImageItem;->mExportHeight:I
...
.method public getExportWidth()I
    ...
    .prologue
    iget v0, p0, Landroid/media/videoeditor/MediaImageItem;->mExportWidth:I
...
.method public getGeneratedClipHeight()I
    .locals 1
...
.method public getGeneratedClipWidth()I
    .locals 1
...
.method public getImageClipProperties()Landroid/media/videoeditor/MediaArtistNativeHelper$ClipSettings;
    .locals 8
    ...
    invoke-virtual {p0}, Landroid/media/videoeditor/MediaImageItem;->getOriginalImageFileName()Ljava/lang/String;

    move-result-object v6

    iput-object v6, v0, Landroid/media/videoeditor/MediaArtistNativeHelper$ClipSettings;->clipOriginalPath:Ljava/lang/String;
    ...
    invoke-virtual {p0}, Landroid/media/videoeditor/MediaImageItem;->getPreviewWidth()I

    move-result v6

    iput v6, v0, Landroid/media/videoeditor/MediaArtistNativeHelper$ClipSettings;->previewWidth:I

    invoke-virtual {p0}, Landroid/media/videoeditor/MediaImageItem;->getPreviewHeight()I

    move-result v6

    iput v6, v0, Landroid/media/videoeditor/MediaArtistNativeHelper$ClipSettings;->previewHeight:I

    invoke-virtual {p0}, Landroid/media/videoeditor/MediaImageItem;->getExportWidth()I

    move-result v6

    iput v6, v0, Landroid/media/videoeditor/MediaArtistNativeHelper$ClipSettings;->exportWidth:I

    invoke-virtual {p0}, Landroid/media/videoeditor/MediaImageItem;->getExportHeight()I

    move-result v6

    iput v6, v0, Landroid/media/videoeditor/MediaArtistNativeHelper$ClipSettings;->exportHeight:I

    goto :goto_0
.end method

.method protected getKenBurns(Landroid/media/videoeditor/EffectKenBurns;)Landroid/media/videoeditor/MediaArtistNativeHelper$ClipSettings;
    .locals 10
    .param p1, "effectKB"    # Landroid/media/videoeditor/EffectKenBurns;
...
.method public getOriginalImageFileName()Ljava/lang/String;
    .locals 1
...
.method public getPreviewHeight()I
    ...
    .prologue
    iget v0, p0, Landroid/media/videoeditor/MediaImageItem;->mPreviewHeight:I
...
.method public getPreviewWidth()I
    ...
    .prologue
    iget v0, p0, Landroid/media/videoeditor/MediaImageItem;->mPreviewWidth:I
...
.method public getScaledImageFileName()Ljava/lang/String;
    .locals 1
...
.method public getThumbnail(IIJ)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v0, p1, p2}, Landroid/media/videoeditor/MediaImageItem;->scaleImage(Ljava/lang/String;II)Landroid/graphics/Bitmap;
...
.method public getThumbnailList(IIJJI[ILandroid/media/videoeditor/MediaItem$GetThumbnailListCallback;)V
    ...
    invoke-virtual {v0, v3, v1, v2}, Landroid/media/videoeditor/MediaImageItem;->scaleImage(Ljava/lang/String;II)Landroid/graphics/Bitmap;
...
.method protected getWidthByAspectRatioAndHeight(II)I
    .locals 4
...
.method protected invalidateBeginTransition(Ljava/util/List;Ljava/util/List;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected invalidateEndTransition()V
    .locals 11
...
.method protected scaleImage(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    .locals 19
    .param p1, "filename"    # Ljava/lang/String;
    .param p2, "width"    # I
    .param p3, "height"    # I
...
.method public setDuration(J)V
    ...
    invoke-virtual {p0}, Landroid/media/videoeditor/MediaImageItem;->invalidateEndTransition()V
    ...
    invoke-virtual {p0}, Landroid/media/videoeditor/MediaImageItem;->adjustOverlays()Ljava/util/List;

    move-result-object v1

    .local v1, "adjustedOverlays":Ljava/util/List;, "Ljava/util/List<Landroid/media/videoeditor/Overlay;>;"
    invoke-virtual {p0}, Landroid/media/videoeditor/MediaImageItem;->adjustEffects()Ljava/util/List;

    move-result-object v0

    .local v0, "adjustedEffects":Ljava/util/List;, "Ljava/util/List<Landroid/media/videoeditor/Effect;>;"
    invoke-virtual {p0, v0, v1}, Landroid/media/videoeditor/MediaImageItem;->invalidateBeginTransition(Ljava/util/List;Ljava/util/List;)V
...
.method public setGeneratedImageClip(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/media/videoeditor/MediaImageItem;->getWidthByAspectRatioAndHeight(II)I

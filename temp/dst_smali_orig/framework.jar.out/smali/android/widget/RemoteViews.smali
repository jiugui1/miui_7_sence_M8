...
# instance fields
.field private final REMOVE_DUPLICATE_ACTION:Z

.field private forceTimeout:Z

.field private final mActionMap:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.method private constructor <init>(Landroid/os/Parcel;Landroid/widget/RemoteViews$BitmapCache;)V
    ...
    iput-boolean v4, p0, Landroid/widget/RemoteViews;->REMOVE_DUPLICATE_ACTION:Z

    new-instance v6, Ljava/util/HashMap;

    invoke-direct {v6}, Ljava/util/HashMap;-><init>()V

    iput-object v6, p0, Landroid/widget/RemoteViews;->mActionMap:Ljava/util/HashMap;

    iput-boolean v5, p0, Landroid/widget/RemoteViews;->forceTimeout:Z
...
.method public constructor <init>(Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-boolean v3, p0, Landroid/widget/RemoteViews;->REMOVE_DUPLICATE_ACTION:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Landroid/widget/RemoteViews;->mActionMap:Ljava/util/HashMap;

    iput-boolean v1, p0, Landroid/widget/RemoteViews;->forceTimeout:Z
...
.method public constructor <init>(Ljava/lang/String;I)V
    ...
    iput-boolean v2, p0, Landroid/widget/RemoteViews;->forceTimeout:Z
...
.method private optimizeDuplicateAction()V
    .locals 5
    ...
    .local v2, "newAction":Landroid/widget/RemoteViews$Action;
    if-eqz v2, :cond_2

    invoke-virtual {v2}, Landroid/widget/RemoteViews$Action;->getUniqueKey()Ljava/lang/String;

    move-result-object v1

    .local v1, "key":Ljava/lang/String;
    :goto_1
    iget-object v3, p0, Landroid/widget/RemoteViews;->mActionMap:Ljava/util/HashMap;
    ...
    .local v0, "duplicateAction":Landroid/widget/RemoteViews$Action;
    iget-object v3, p0, Landroid/widget/RemoteViews;->mActions:Ljava/util/ArrayList;
    ...
    .end local v0    # "duplicateAction":Landroid/widget/RemoteViews$Action;
...
.method private performApply(Landroid/view/View;Landroid/view/ViewGroup;Landroid/widget/RemoteViews$OnClickHandler;)V
    ...
    iget-boolean v5, p0, Landroid/widget/RemoteViews;->forceTimeout:Z
    ...
    const-string v5, "RemoteViews.Performance"
...
.method private prepareContext(Landroid/content/Context;)Landroid/content/Context;
    ...
    :try_start_0
    iget-object v9, p0, Landroid/widget/RemoteViews;->mUser:Landroid/os/UserHandle;

    invoke-virtual {p1, v6, v8, v9}, Landroid/content/Context;->createPackageContextAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/Context;
    :try_end_0
    ...
    :goto_0
    invoke-direct {p0, v6}, Landroid/widget/RemoteViews;->isHTCitem(Ljava/lang/String;)Z

    move-result v4

    .local v4, "isHTCitem":Z
    const/4 v7, 0x0
    ...
    :try_start_1
    const-string v8, "com.htc.configuration.HtcWrapConfiguration"
    ...
    invoke-virtual {v0, v7}, Landroid/content/Context;->setTheme(I)V
    :try_end_1
    ...
    const-string v10, "reflection fail:"
...
.method public setForceTimeout(Z)V
    ...
    .prologue
    iput-boolean p1, p0, Landroid/widget/RemoteViews;->forceTimeout:Z
...
.method public setProgressBar(IIIZ)V
    ...
    invoke-direct {p0}, Landroid/widget/RemoteViews;->optimizeDuplicateAction()V

...
.field private mMaxMemoryLimitInBytes:I
...
.method public constructor <init>(I)V
    ...
    iput v0, p0, Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;->mMaxMemoryLimitInBytes:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;->mRealData:J
...
.method static synthetic access$1400(Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;)Landroid/widget/RemoteViewsAdapter$RemoteViewsMetaData;
    .locals 1
...
.method static synthetic access$1500(Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;)Ljava/util/HashMap;
    .locals 1
    .param p0, "x0"    # Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;
...
.method public containsRemoteViewAt(I)Z
    ...
    iget-boolean v1, v1, Landroid/widget/RemoteViewsAdapter$RemoteViewsMetaData;->reapplyOnLoaded:Z
    ...
    .local v0, "tmp":Landroid/widget/RemoteViewsAdapter$RemoteViewsIndexMetaData;
    if-eqz v0, :cond_0
    ...
    invoke-virtual {p0, p1}, Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;->getCurrentData(I)Z

    move-result v1

    .end local v0    # "tmp":Landroid/widget/RemoteViewsAdapter$RemoteViewsIndexMetaData;
    :goto_0
    return v1

    :cond_0
    iget-object v1, p0, Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;->mIndexRemoteViews:Ljava/util/HashMap;
...
.method getCurrentData(I)Z
    .locals 6
    .param p1, "p"    # I

    .prologue
    iget-wide v4, p0, Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;->mRealData:J
...
.method public insert(ILandroid/widget/RemoteViews;JLjava/util/ArrayList;)V
    ...
    iget v3, p0, Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;->mMaxMemoryLimitInBytes:I
...
.method public pruneCache(I)V
    ...
    iget-object v1, p0, Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;->mIndexMetaData:Ljava/util/HashMap;
...
.method public reset()V
    ...
    iget-boolean v0, v0, Landroid/widget/RemoteViewsAdapter$RemoteViewsMetaData;->reapplyOnLoaded:Z
...
.method setCurrentData(I)V
    ...
    .local v0, "target":J
    iget-wide v2, p0, Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;->mRealData:J

    or-long/2addr v2, v0

    iput-wide v2, p0, Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;->mRealData:J

    goto :goto_0
.end method

.method setMaxMemoryLimitInBytes(I)V
    .locals 0
    .param p1, "m"    # I

    .prologue
    iput p1, p0, Landroid/widget/RemoteViewsAdapter$FixedSizeRemoteViewsCache;->mMaxMemoryLimitInBytes:I
...
.method setReapplyOnLoaded(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/widget/RemoteViewsAdapter$RemoteViewsMetaData;->setReapplyOnLoaded(Z)V

...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lcom/android/server/content/SyncManager;->HtcIsLargeRAM()Z
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    invoke-direct {p0}, Lcom/android/server/content/SyncManager;->checkIsaVersion()Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/server/content/SyncManager;->IsaVersion:Z
...
.method private static HtcIsLargeRAM()Z
    .locals 5
    ...
    const-string v3, "get device ram size is "
...
.method static synthetic access$1700(Lcom/android/server/content/SyncManager;)Z
    ...
    .prologue
    iget-boolean v0, p0, Lcom/android/server/content/SyncManager;->IsaVersion:Z
...
.method static synthetic access$2300(Lcom/android/server/content/SyncManager;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$2302(Lcom/android/server/content/SyncManager;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
    .param p1, "x1"    # Z
...
.method static synthetic access$2400(Lcom/android/server/content/SyncManager;)Landroid/os/PowerManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$2500(Lcom/android/server/content/SyncManager;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$2600(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncManager$ActiveSyncContext;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
    .param p1, "x1"    # Lcom/android/server/content/SyncManager$ActiveSyncContext;
...
.method static synthetic access$2800(Lcom/android/server/content/SyncManager;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$2900(Lcom/android/server/content/SyncManager;)Landroid/app/PendingIntent;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$3000(Lcom/android/server/content/SyncManager;)Landroid/app/AlarmManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$3200(Lcom/android/server/content/SyncManager;)[Landroid/accounts/AccountAndUser;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$3400(Lcom/android/server/content/SyncManager;[Landroid/accounts/AccountAndUser;Landroid/accounts/Account;I)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$3500()[Landroid/accounts/AccountAndUser;
    .locals 1
...
.method static synthetic access$3600(Lcom/android/server/content/SyncManager;)Landroid/os/StatFs;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$3700(Lcom/android/server/content/SyncManager;)Landroid/os/UserManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method private checkIsaVersion()Z
    .locals 5
...
.method private clearAllScheduledSyncOperations()V
    ...
    .prologue
    iget-object v11, p0, Lcom/android/server/content/SyncManager;->mSyncQueue:Lcom/android/server/content/SyncQueue;
    ...
    .local v10, "operationIterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/content/SyncOperation;>;"
    ...
    iget-object v1, v9, Lcom/android/server/content/SyncOperation;->pendingOperation:Lcom/android/server/content/SyncStorageEngine$PendingOperation;
    ...
    iget-object v1, v9, Lcom/android/server/content/SyncOperation;->account:Landroid/accounts/Account;

    iget v2, v9, Lcom/android/server/content/SyncOperation;->userId:I

    iget-object v3, v9, Lcom/android/server/content/SyncOperation;->authority:Ljava/lang/String;
    ...
    .end local v10    # "operationIterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/content/SyncOperation;>;"
    :catchall_0
    move-exception v0
    ...
    .restart local v10    # "operationIterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/content/SyncOperation;>;"
    :cond_3
    :try_start_1
    monitor-exit v11
    :try_end_1
...
.method private initSettingsObserver()V
    ...
    const-string v5, "initObserver()"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_0
    new-instance v4, Lcom/android/server/content/SyncManager$SettingsObserver;

    const/4 v5, 0x0

    invoke-direct {v4, p0, v5}, Lcom/android/server/content/SyncManager$SettingsObserver;-><init>(Lcom/android/server/content/SyncManager;Landroid/os/Handler;)V

    iput-object v4, p0, Lcom/android/server/content/SyncManager;->mSettingsObserver:Lcom/android/server/content/SyncManager$SettingsObserver;
    ...
    iget-object v5, p0, Lcom/android/server/content/SyncManager;->mSettingsObserver:Lcom/android/server/content/SyncManager$SettingsObserver;
...
.method protected dumpSyncState(Ljava/io/PrintWriter;)V
    ...
    invoke-static/range {v34 .. v34}, Lcom/android/server/content/SyncManager$SyncHandler;->access$1800(Lcom/android/server/content/SyncManager$SyncHandler;)Ljava/lang/Long;
...
.method public scheduleSync(Landroid/accounts/Account;IILjava/lang/String;Landroid/os/Bundle;JJZ)V
    ...
    const-string v4, "scheduleSync: EPS mode, manualSync = "
    ...
    const-string v4, ", isForegroundSync = "

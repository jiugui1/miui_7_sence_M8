...
.method constructor <init>(Lcom/android/server/LocationManagerService;Landroid/location/ILocationListener;Landroid/app/PendingIntent;IILjava/lang/String;Landroid/os/WorkSource;Z)V
    ...
    # invokes: Lcom/android/server/LocationManagerService;->isSuperApp(Ljava/lang/String;)Z
    invoke-static {p1, p6}, Lcom/android/server/LocationManagerService;->access$600(Lcom/android/server/LocationManagerService;Ljava/lang/String;)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/server/LocationManagerService$Receiver;->isSuperApp:Z
...
.method public callProviderEnabledLocked(Ljava/lang/String;Z)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/LocationManagerService$Receiver;->isSuperApp:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/server/LocationManagerService$Receiver;->this$0:Lcom/android/server/LocationManagerService;

    # getter for: Lcom/android/server/LocationManagerService;->mBackdoorMode:I
    invoke-static {v0}, Lcom/android/server/LocationManagerService;->access$1400(Lcom/android/server/LocationManagerService;)I

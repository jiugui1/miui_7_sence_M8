...
.method doHandleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v3}, Lcom/android/server/pm/PackageManagerService;->access$700(Lcom/android/server/pm/PackageManagerService;)Z
    ...
    invoke-static {v3, v4}, Lcom/android/server/pm/PackageManagerService;->access$800(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;)V
    ...
    const-string v6, "PackageInstallObserver no longer exists., name:"
    ...
    const-string v4, "WRITE_PACKAGE_RESTRICTIONS"
    ...
    const-string v6, "CHECK_PENDING_VERIFICATION timeExt:"
    ...
    invoke-static {v3, v0, v4}, Lcom/android/server/pm/PackageManagerService;->access$1700(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/PackageManagerService$InstallArgs;Ljava/io/File;)Z
    ...
    const-string v6, "CHECK_PENDING_VERIFICATION state:null id:"
    ...
    const-string v6, "PACKAGE_VERIFIED allow:"
    ...
    const-string v6, "PACKAGE_VERIFIED not complete. id:"
    ...
    const-string v6, "3LM, Scan timed out for "
    ...
    const-string v4, "3LM, Failing package install after timeout"
    ...
    const-string v6, "3LM, Couldn\'t delete temporary file: "
    ...
    const-string v4, "3LM, Could not contact the ContainerService"
    ...
    const-string v6, "3LM, Invalid scan token "
    ...
    # invokes: Lcom/android/server/pm/PackageManagerService;->nativeSetDebugZip(Z)V
    invoke-static {v3, v4}, Lcom/android/server/pm/PackageManagerService;->access$1900(Lcom/android/server/pm/PackageManagerService;Z)V
    ...
    invoke-virtual {v3, v4}, Ldalvik/system/VMRuntime;->gcSoftReferences(Z)V

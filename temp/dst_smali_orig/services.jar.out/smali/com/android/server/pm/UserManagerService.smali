...
.method static synthetic access$600(Lcom/android/server/pm/UserManagerService;Ljava/lang/String;I)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/pm/UserManagerService;
...
.method static synthetic access$700(Lcom/android/server/pm/UserManagerService;Ljava/lang/String;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/pm/UserManagerService;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # I
...
.method private readUserListLocked()V
    ...
    const-string v11, "No owner, fallbackToSingleUser"
...
.method private readUserLocked(I)Landroid/content/pm/UserInfo;
    ...
    .local v23, "restrictions":Landroid/os/Bundle;
    const/4 v8, 0x0

    .local v8, "fis":Ljava/io/FileInputStream;
    :try_start_0
    new-instance v30, Landroid/util/AtomicFile;
    ...
    .local v30, "userFile":Landroid/util/AtomicFile;
    invoke-virtual/range {v30 .. v30}, Landroid/util/AtomicFile;->openRead()Ljava/io/FileInputStream;
    ...
    const-string v33, "UserManagerService"
    ...
    .end local v30    # "userFile":Landroid/util/AtomicFile;
    :cond_2
    :goto_0
    return-object v31
    ...
    .restart local v30    # "userFile":Landroid/util/AtomicFile;
    :cond_3
    const/16 v33, 0x2
    ...
    const-string v34, "User id does not match the file name"
    ...
    .end local v27    # "storedId":I
    :catch_0
    move-exception v33

    goto :goto_0

    .restart local v27    # "storedId":I
    :cond_4
    :try_start_4
    ...
    const-string v33, "failedAttempts"
    ...
    const-string v33, "lastAttemptMs"
    ...
    const-string v33, "no_config_wifi"
    ...
    const-string v33, "no_modify_accounts"
    ...
    const-string v33, "no_install_apps"
    ...
    const-string v33, "no_uninstall_apps"
    ...
    const-string v33, "no_share_location"
    ...
    const-string v33, "no_install_unknown_sources"
    ...
    const-string v33, "no_config_bluetooth"
    ...
    const-string v33, "no_usb_file_transfer"
    ...
    const-string v33, "no_config_credentials"
    ...
    const-string v33, "no_remove_user"
    ...
    const-string v35, "readUser fail, id="
    ...
    invoke-direct {v0, v1, v2, v10, v9}, Landroid/content/pm/UserInfo;-><init>(ILjava/lang/String;Ljava/lang/String;I)V
    ...
    iput-wide v12, v0, Lcom/android/server/pm/UserManagerService$RestrictionsPinState;->lastAttemptTime:J
    :try_end_7
    .catch Ljava/io/IOException; {:try_start_7 .. :try_end_7} :catch_1
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_7 .. :try_end_7} :catch_2
    .catchall {:try_start_7 .. :try_end_7} :catchall_0

...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/AppWidgetServiceImpl;->sUseForegroundFlag:Z
...
.method private canBindHtcAppWigdet(Z)Z
    ...
    invoke-direct {p0, v2}, Lcom/android/server/AppWidgetServiceImpl;->getProcessName(I)Ljava/lang/String;
...
.method private parseProviderInfoXml(Landroid/content/ComponentName;Landroid/content/pm/ResolveInfo;)Lcom/android/server/AppWidgetServiceImpl$Provider;
    ...
    const-string v15, "htcControlFlag"

    sget v16, Landroid/appwidget/AppWidgetProviderInfo;->HTC_CTRL_DEFAULT:I

    move/from16 v0, v16

    invoke-interface {v2, v14, v15, v0}, Landroid/util/AttributeSet;->getAttributeIntValue(Ljava/lang/String;Ljava/lang/String;I)I

    move-result v14

    iput v14, v5, Landroid/appwidget/AppWidgetProviderInfo;->htcControlFlag:I
    :try_end_2
...
.method backupAppWidgetData(ILandroid/os/Bundle;)V
    .locals 6
    .param p1, "appWidgetId"    # I
    ...
    iget-boolean v2, v2, Lcom/android/server/AppWidgetServiceImpl$Host;->zombie:Z

    if-nez v2, :cond_2

    iget-object v2, v1, Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;->host:Lcom/android/server/AppWidgetServiceImpl$Host;

    iget-object v2, v2, Lcom/android/server/AppWidgetServiceImpl$Host;->callbacks:Lcom/android/internal/appwidget/IAppWidgetHost;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v4, "backup appwidget, send to host"
    ...
    iget v4, v1, Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;->appWidgetId:I

    iget v5, p0, Lcom/android/server/AppWidgetServiceImpl;->mUserId:I

    invoke-interface {v2, v4, p2, v5}, Lcom/android/internal/appwidget/IAppWidgetHost;->backupAppWidgetData(ILandroid/os/Bundle;I)V
    :try_end_1
...
.method public getInstalledProviders(I)Ljava/util/List;
    ...
    invoke-direct {p0, v1}, Lcom/android/server/AppWidgetServiceImpl;->canBindHtcAppWigdet(Z)Z

    move-result v6

    if-nez v6, :cond_0

    .local v1, "canNotAccessHtcAppWidget":Z
    :goto_0
    iget-object v6, p0, Lcom/android/server/AppWidgetServiceImpl;->mAppWidgetIds:Ljava/util/ArrayList;
    ...
    .end local v1    # "canNotAccessHtcAppWidget":Z
    :cond_0
    move v1, v5

    goto :goto_0

    .restart local v1    # "canNotAccessHtcAppWidget":Z
    :cond_1
    invoke-direct {p0}, Lcom/android/server/AppWidgetServiceImpl;->ensureStateLoadedLocked()V
    ...
    sget v5, Landroid/appwidget/AppWidgetProviderInfo;->HTC_CTRL_HTC_ROSIE_ONLY:I

    iget-object v7, v3, Lcom/android/server/AppWidgetServiceImpl$Provider;->info:Landroid/appwidget/AppWidgetProviderInfo;

    iget v7, v7, Landroid/appwidget/AppWidgetProviderInfo;->htcControlFlag:I
    ...
    :cond_3
    iget-boolean v5, v3, Lcom/android/server/AppWidgetServiceImpl$Provider;->zombie:Z

    if-nez v5, :cond_2

    iget-object v5, v3, Lcom/android/server/AppWidgetServiceImpl$Provider;->info:Landroid/appwidget/AppWidgetProviderInfo;

    iget v5, v5, Landroid/appwidget/AppWidgetProviderInfo;->widgetCategory:I
    ...
    invoke-direct {p0, v5}, Lcom/android/server/AppWidgetServiceImpl;->cloneIfLocalBinder(Landroid/appwidget/AppWidgetProviderInfo;)Landroid/appwidget/AppWidgetProviderInfo;
    ...
    .restart local v4    # "result":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/appwidget/AppWidgetProviderInfo;>;"
    :cond_4
    :try_start_1
    monitor-exit v6
    :try_end_1
...
.method onBroadcastReceived(Landroid/content/Intent;)V
    ...
    sput-boolean v11, Lcom/android/server/AppWidgetServiceImpl;->sUseForegroundFlag:Z
...
.method onConfigurationChanged()V
    ...
    sput-boolean v7, Lcom/android/server/AppWidgetServiceImpl;->sUseForegroundFlag:Z
...
.method sendEnableIntentLocked(Lcom/android/server/AppWidgetServiceImpl$Provider;)V
    ...
    sget-boolean v2, Lcom/android/server/AppWidgetServiceImpl;->sUseForegroundFlag:Z
...
.method sendInitialBroadcasts()V
    ...
    sput-boolean v4, Lcom/android/server/AppWidgetServiceImpl;->sUseForegroundFlag:Z
    ...
    const-string v7, "sendInitialBroadcasts(), set sUseForegroundFlag = "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget-boolean v7, Lcom/android/server/AppWidgetServiceImpl;->sUseForegroundFlag:Z
...
.method public updateAppWidgetOptions(ILandroid/os/Bundle;)V
    ...
    :cond_1
    :try_start_1
    iget-object v3, v1, Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;->provider:Lcom/android/server/AppWidgetServiceImpl$Provider;

    .local v3, "p":Lcom/android/server/AppWidgetServiceImpl$Provider;
    iget-object v4, v1, Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;->options:Landroid/os/Bundle;

    invoke-virtual {v4, p2}, Landroid/os/Bundle;->putAll(Landroid/os/Bundle;)V

    iget-object v0, v1, Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;->options:Landroid/os/Bundle;

    .local v0, "b":Landroid/os/Bundle;
    const-string v4, "appWidgetBackup"
    ...
    invoke-direct {p0, v4}, Lcom/android/server/AppWidgetServiceImpl;->canBindHtcAppWigdet(Z)Z
    ...
    const-string v6, "appWidgetBackup"
    ...
    iget v6, v1, Lcom/android/server/AppWidgetServiceImpl$AppWidgetId;->appWidgetId:I
    ...
    iget v7, p0, Lcom/android/server/AppWidgetServiceImpl;->mUserId:I

...
.method public enable()Z
    ...
    const-string v19, "BluetoothManagerService"

    const-string v20, "enable(): not allowed for non-active and non system user"
    ...
    const-string v20, "android.permission.BLUETOOTH_ADMIN"

    const-string v21, "Need BLUETOOTH ADMIN permission"
    ...
    .local v8, "customManager":Lcom/htc/customization/HtcCustomizationManager;
    ...
    .local v9, "customReader":Lcom/htc/customization/HtcCustomizationReader;
    ...
    invoke-interface {v9, v0, v1}, Lcom/htc/customization/HtcCustomizationReader;->readInteger(Ljava/lang/String;I)I

    move-result v16

    .local v16, "regionId":I
    const-string v19, "BluetoothManagerService"
    ...
    const-string v21, "enable(): region ID = "
    ...
    .local v5, "callerPackageNames":[Ljava/lang/String;
    move-object v3, v5
    ...
    const-string v21, "enable(): Parsed package name is "
    ...
    sget-object v4, Lcom/android/server/BluetoothManagerService;->ENABLE_WHITELIST:[Ljava/lang/String;
    ...
    .local v17, "whiteList":Ljava/lang/String;
    ...
    const-string v20, "enable(): Matched white list"

    invoke-static/range {v19 .. v20}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const/16 v18, 0x1

    .end local v17    # "whiteList":Ljava/lang/String;
    :cond_2
    if-eqz v18, :cond_5
    ...
    const-string v19, "android.bluetooth.adapter.action.REQUEST_ENABLE"
    ...
    .restart local v17    # "whiteList":Ljava/lang/String;
    :cond_4
    ...
    .end local v4    # "arr$":[Ljava/lang/String;
    .end local v5    # "callerPackageNames":[Ljava/lang/String;
    .end local v11    # "i$":I
    .end local v14    # "len$":I
    .end local v15    # "names":Ljava/lang/String;
    .end local v18    # "whiteListMatch":Z
    :cond_6
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v19 .. v20}, Lcom/android/server/BluetoothManagerService$BluetoothHandler;->removeMessages(I)V
    ...
    const-string v21, "enable():  mBluetooth ="

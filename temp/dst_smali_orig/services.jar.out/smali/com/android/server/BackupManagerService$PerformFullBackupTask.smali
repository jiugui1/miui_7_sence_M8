...
.method static synthetic access$1700(Lcom/android/server/BackupManagerService$PerformFullBackupTask;Landroid/content/pm/PackageInfo;Ljava/io/File;Z)V
    .locals 0
...
.method static synthetic access$1800(Lcom/android/server/BackupManagerService$PerformFullBackupTask;Landroid/content/pm/PackageInfo;Landroid/app/backup/BackupDataOutput;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BackupManagerService$PerformFullBackupTask;
    .param p1, "x1"    # Landroid/content/pm/PackageInfo;
...
.method private backupOnePackage(Landroid/content/pm/PackageInfo;Ljava/io/OutputStream;)V
    ...
    invoke-static {v1, v2, p2}, Lcom/android/server/BackupManagerService;->access$1600(Lcom/android/server/BackupManagerService;Landroid/os/ParcelFileDescriptor;Ljava/io/OutputStream;)V
    :try_end_1
...
.method private emitAesBackupHeader(Ljava/lang/StringBuilder;Ljava/io/OutputStream;)Ljava/io/OutputStream;
    ...
    invoke-static/range {v19 .. v20}, Lcom/android/server/BackupManagerService;->access$2000(Lcom/android/server/BackupManagerService;I)[B
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lcom/android/server/BackupManagerService;->access$2100(Lcom/android/server/BackupManagerService;Ljava/lang/String;Ljava/lang/String;[BI)Ljavax/crypto/SecretKey;
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/BackupManagerService;->access$2200(Lcom/android/server/BackupManagerService;)Ljava/security/SecureRandom;
    ...
    invoke-static {v0, v1}, Lcom/android/server/BackupManagerService;->access$2300(Lcom/android/server/BackupManagerService;[B)Ljava/lang/String;
    ...
    # invokes: Lcom/android/server/BackupManagerService;->byteArrayToHex([B)Ljava/lang/String;
    invoke-static {v0, v9}, Lcom/android/server/BackupManagerService;->access$2300(Lcom/android/server/BackupManagerService;[B)Ljava/lang/String;
    ...
    # invokes: Lcom/android/server/BackupManagerService;->byteArrayToHex([B)Ljava/lang/String;
    invoke-static {v0, v5}, Lcom/android/server/BackupManagerService;->access$2300(Lcom/android/server/BackupManagerService;[B)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2, v9, v3}, Lcom/android/server/BackupManagerService;->access$2400(Lcom/android/server/BackupManagerService;Ljava/lang/String;[B[BI)[B
    ...
    # invokes: Lcom/android/server/BackupManagerService;->byteArrayToHex([B)Ljava/lang/String;
    invoke-static {v0, v10}, Lcom/android/server/BackupManagerService;->access$2300(Lcom/android/server/BackupManagerService;[B)Ljava/lang/String;
...
.method private tearDown(Landroid/content/pm/PackageInfo;)V
    ...
    invoke-static {v2}, Lcom/android/server/BackupManagerService;->access$1400(Lcom/android/server/BackupManagerService;)Landroid/app/IActivityManager;
...
.method public run()V
    ...
    # getter for: Lcom/android/server/BackupManagerService;->mPackageManager:Landroid/content/pm/PackageManager;
    invoke-static/range {v23 .. v23}, Lcom/android/server/BackupManagerService;->access$1000(Lcom/android/server/BackupManagerService;)Landroid/content/pm/PackageManager;
    ...
    invoke-static/range {v23 .. v24}, Lcom/android/server/BackupManagerService;->access$1900(Lcom/android/server/BackupManagerService;Ljava/lang/String;)Z
    ...
    iput-boolean v0, v1, Lcom/android/server/BackupManagerService;->mFullBackupRunning:Z

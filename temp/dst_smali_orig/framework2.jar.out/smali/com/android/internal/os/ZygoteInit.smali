...
.method static constructor <clinit>()V
    ...
    const-string v1, "sys.zygote.first.init"
    ...
    const-string v1, "persist.zygote.preload_threads"
    ...
    const-string v1, "persist.preload.common"
...
.method public static main([Ljava/lang/String;)V
    ...
    sget v3, Lcom/android/internal/os/ZygoteInit;->FIRST_INIT:I

    if-nez v3, :cond_0

    const-string v3, "Zygote"

    const-string v4, "FIRST_INIT_NORMAL is default value, FIRST_INIT = 0"

    invoke-static {v3, v4}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    const-string v3, "sys.zygote.first.init"
    ...
    .end local v0    # "VZW_LOGGER_PROPERTY":Ljava/lang/String;
    :catch_0
    move-exception v1
    ...
    .restart local v0    # "VZW_LOGGER_PROPERTY":Ljava/lang/String;
    :cond_0
    :try_start_1
    const-string v3, "Zygote"

    const-string v4, "FIRST_INIT is not default value, FIRST_INIT = 1"

    invoke-static {v3, v4}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    const-string v3, "persist.sys.vzwlogger.zygote"

    const-string v4, "Q001"
...
.method private static startSystemServer()Z
    ...
    const-string v1, "--setgroups=1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1018,1021,1032,3001,3002,3003,3004,3006,3007,3008,5001,9985,5011"

...
.method bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;II)I
    ...
    invoke-virtual {v0, v6, v7, v8, v1}, Landroid/content/Intent;->toShortString(ZZZZ)Ljava/lang/String;
...
.method dumpServicesLocked(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;IZZLjava/lang/String;)V
    ...
    const-string v36, "dumpsys activity services), "
    ...
    const-string v35, "begin (dumpsys activity services)"

    invoke-static/range {v34 .. v35}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    const-string v34, "ACTIVITY MANAGER SERVICES (dumpsys activity services)"
    ...
    invoke-virtual/range {v34 .. v34}, Lcom/android/server/am/ActivityManagerService;->getUsersLocked()[I
    ...
    const-string v36, "(dumpsys activity services) (1): "
    ...
    const-string v35, " active services:"
    ...
    :try_start_1
    new-instance v31, Lcom/android/internal/os/TransferPipe;

    invoke-direct/range {v31 .. v31}, Lcom/android/internal/os/TransferPipe;-><init>()V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_2
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1

    .local v31, "tp":Lcom/android/internal/os/TransferPipe;
    :try_start_2
    move-object/from16 v0, v25
    ...
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/os/TransferPipe;->getWriteFd()Landroid/os/ParcelFileDescriptor;

    move-result-object v35

    invoke-virtual/range {v35 .. v35}, Landroid/os/ParcelFileDescriptor;->getFileDescriptor()Ljava/io/FileDescriptor;
    ...
    :try_start_3
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/os/TransferPipe;->kill()V
    :try_end_3
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_3} :catch_0
    .catch Landroid/os/RemoteException; {:try_start_3 .. :try_end_3} :catch_2
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_3} :catch_1

    .end local v31    # "tp":Lcom/android/internal/os/TransferPipe;
    :goto_3
    const/16 v19, 0x1
    ...
    invoke-virtual/range {v34 .. v34}, Landroid/content/Intent$FilterComparison;->getIntent()Landroid/content/Intent;
    ...
    invoke-virtual/range {v34 .. v38}, Landroid/content/Intent;->toShortString(ZZZZ)Ljava/lang/String;
    ...
    .end local v14    # "i":I
    .restart local v31    # "tp":Lcom/android/internal/os/TransferPipe;
    :catchall_0
    move-exception v34
    ...
    const-string v35, "      Failure while dumping the service: "
    ...
    .end local v32    # "user":I
    .end local v33    # "users":[I
    :catch_1
    move-exception v13
    ...
    const-string v35, "Exception in dumpServicesLocked"
    ...
    const-string v36, "(dumpsys activity services) (2): "
    ...
    const-string v36, "(dumpsys activity services) (3): "
    ...
    const-string v36, "(dumpsys activity services) (4): "
    ...
    .restart local v32    # "user":I
    .restart local v33    # "users":[I
    :catch_2
    move-exception v13

    .local v13, "e":Landroid/os/RemoteException;
    :try_start_7
    const-string v34, "      Got a RemoteException while dumping the service"
    ...
    const-string v35, " delayed start services:"
    ...
    const-string v34, "  * Delayed start "
    ...
    const-string v35, " starting in background:"
    ...
    const-string v34, "  Pending services:"
    ...
    const-string v34, "  Restarting services:"
    ...
    const-string v34, "  Destroying services:"
    ...
    const-string v36, "(dumpsys activity services) (5): "
    ...
    const-string v34, "  Connection bindings to services:"
    ...
    const-string v36, "end (dumpsys activity services), "
...
.method final killServicesLocked(Lcom/android/server/am/ProcessRecord;Z)V
    ...
    iget-object v13, v10, Lcom/android/server/am/ServiceRecord;->stats:Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;

    invoke-virtual {v13}, Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;->getBatteryStats()Lcom/android/internal/os/BatteryStatsImpl;
    ...
    invoke-virtual {v13}, Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;->stopLaunchedLocked()V

    monitor-exit v14
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v13, v10, Lcom/android/server/am/ServiceRecord;->app:Lcom/android/server/am/ProcessRecord;
    ...
    iget-boolean v13, v13, Lcom/android/server/am/ProcessRecord;->persistent:Z

    if-nez v13, :cond_0

    iget-object v13, v10, Lcom/android/server/am/ServiceRecord;->app:Lcom/android/server/am/ProcessRecord;

    iget-object v13, v13, Lcom/android/server/am/ProcessRecord;->services:Landroid/util/ArraySet;

    invoke-virtual {v13, v10}, Landroid/util/ArraySet;->remove(Ljava/lang/Object;)Z

    :cond_0
    const/4 v13, 0x0

    iput-object v13, v10, Lcom/android/server/am/ServiceRecord;->app:Lcom/android/server/am/ProcessRecord;

    const/4 v13, 0x0

    iput-object v13, v10, Lcom/android/server/am/ServiceRecord;->isolatedProc:Lcom/android/server/am/ProcessRecord;

    const/4 v13, 0x0

    iput v13, v10, Lcom/android/server/am/ServiceRecord;->executeNesting:I

    invoke-virtual {v10}, Lcom/android/server/am/ServiceRecord;->forceClearTracker()V

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/server/am/ActiveServices;->mDestroyingServices:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v13, v10, Lcom/android/server/am/ServiceRecord;->bindings:Landroid/util/ArrayMap;
    ...
    iput-object v13, v2, Lcom/android/server/am/IntentBindRecord;->binder:Landroid/os/IBinder;

    const/4 v13, 0x0

    iput-boolean v13, v2, Lcom/android/server/am/IntentBindRecord;->hasBound:Z

    iput-boolean v13, v2, Lcom/android/server/am/IntentBindRecord;->received:Z

    iput-boolean v13, v2, Lcom/android/server/am/IntentBindRecord;->requested:Z
    ...
    .restart local v3    # "bindingi":I
    .restart local v7    # "numClients":I
    :cond_2
    ...
    iget-object v13, v0, Lcom/android/server/am/ProcessRecord;->connections:Landroid/util/ArraySet;
    ...
    const-string v15, "Connection Record size = "
    ...
    iget-object v15, v0, Lcom/android/server/am/ProcessRecord;->connections:Landroid/util/ArraySet;
    ...
    .local v8, "r":Lcom/android/server/am/ConnectionRecord;
    const/4 v13, 0x0
    ...
    invoke-virtual {v0, v8, v1, v13}, Lcom/android/server/am/ActiveServices;->removeConnectionLocked(Lcom/android/server/am/ConnectionRecord;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ActivityRecord;)V

    add-int/lit8 v6, v6, -0x1

    goto :goto_2

    .end local v8    # "r":Lcom/android/server/am/ConnectionRecord;
    :cond_5
    move-object/from16 v0, p1
    ...
    const-string v15, "Remove connections done "
    ...
    invoke-direct {v0, v13}, Lcom/android/server/am/ActiveServices;->getServiceMap(I)Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    iget-boolean v13, v0, Lcom/android/server/am/ProcessRecord;->persistent:Z
    ...
    invoke-virtual {v13, v6}, Landroid/util/ArraySet;->removeAt(I)Ljava/lang/Object;

    :cond_7
    iget-object v13, v9, Lcom/android/server/am/ActiveServices$ServiceMap;->mServicesByName:Landroid/util/ArrayMap;

    iget-object v14, v10, Lcom/android/server/am/ServiceRecord;->name:Landroid/content/ComponentName;
    ...
    const-string v15, " not same as in map: "
    ...
    iget v13, v10, Lcom/android/server/am/ServiceRecord;->crashCount:I

    const/4 v14, 0x2

    if-lt v13, v14, :cond_a

    iget-object v13, v10, Lcom/android/server/am/ServiceRecord;->serviceInfo:Landroid/content/pm/ServiceInfo;
    ...
    const-string v15, "Service crashed "

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v14

    iget v15, v10, Lcom/android/server/am/ServiceRecord;->crashCount:I

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v14

    const-string v15, " times, stopping: "
    ...
    invoke-direct {v0, v10}, Lcom/android/server/am/ActiveServices;->bringDownServiceLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    invoke-direct {v0, v10, v13}, Lcom/android/server/am/ActiveServices;->scheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;Z)Z

    move-result v4

    .local v4, "canceled":Z
    iget-boolean v13, v10, Lcom/android/server/am/ServiceRecord;->startRequested:Z

    if-eqz v13, :cond_8

    iget-boolean v13, v10, Lcom/android/server/am/ServiceRecord;->stopIfKilled:Z
    ...
    :cond_c
    iget-object v13, v10, Lcom/android/server/am/ServiceRecord;->pendingStarts:Ljava/util/ArrayList;
    ...
    iput-boolean v13, v10, Lcom/android/server/am/ServiceRecord;->startRequested:Z

    iget-object v13, v10, Lcom/android/server/am/ServiceRecord;->tracker:Lcom/android/internal/app/ProcessStats$ServiceState;
    ...
    invoke-virtual/range {v13 .. v17}, Lcom/android/internal/app/ProcessStats$ServiceState;->setStarted(ZIJ)V
    ...
    iget-object v13, v8, Lcom/android/server/am/ServiceRecord;->processName:Ljava/lang/String;
    ...
    iget-object v13, v8, Lcom/android/server/am/ServiceRecord;->serviceInfo:Landroid/content/pm/ServiceInfo;
    ...
    iget-object v13, v0, Lcom/android/server/am/ActiveServices;->mPendingServices:Ljava/util/ArrayList;
    ...
    iget-object v13, v0, Lcom/android/server/am/ProcessRecord;->executingServices:Landroid/util/ArraySet;
...
.method serviceTimeout(Lcom/android/server/am/ProcessRecord;)V
    ...
    iget-boolean v13, v1, Lcom/android/server/am/ActivityManagerService;->mDuringHibernate:Z
    ...
    iget-object v1, v0, Lcom/android/server/am/ProcessRecord;->executingServices:Landroid/util/ArraySet;
    ...
    iget-boolean v1, v0, Lcom/android/server/am/ProcessRecord;->execServicesFg:Z
    ...
    iget-wide v1, v14, Lcom/android/server/am/ServiceRecord;->executingStart:J
    ...
    iget-wide v4, v4, Lcom/android/server/am/ActivityManagerService;->mResumeFromHibernateTime:J
    ...
    const-string v4, "Fast boot: skip service timeout of :"
    ...
    iget-wide v4, v14, Lcom/android/server/am/ServiceRecord;->executingStart:J
    ...
    iget-object v2, v15, Lcom/android/server/am/ServiceRecord;->shortName:Ljava/lang/String;
    ...
    iget-wide v11, v14, Lcom/android/server/am/ServiceRecord;->executingStart:J
    ...
    iget-object v4, v1, Lcom/android/server/am/ActivityManagerService;->mHandler:Landroid/os/Handler;
    ...
    :goto_5
    invoke-virtual {v4, v10, v1, v2}, Landroid/os/Handler;->sendMessageAtTime(Landroid/os/Message;J)Z
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;III)Landroid/content/ComponentName;
    ...
    invoke-virtual {v0, v4, v5, v6, v8}, Landroid/content/Intent;->toShortString(ZZZZ)Ljava/lang/String;
...
.method stopServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;I)I
    ...
    invoke-virtual {p2, v2, v3, v4, v5}, Landroid/content/Intent;->toShortString(ZZZZ)Ljava/lang/String;

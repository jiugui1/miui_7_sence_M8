...
.method public onDisplayConnected(Landroid/view/Surface;IIII)V
    ...
    const-string v2, "set wifi.miracastlock to 0 for onDisplayConnected case"
    ...
    const-string v2, "Request P2P Find command to be a workaround for BRCM solution data stall"
    ...
    const-string v2, "Stop P2P Find command to be a workaround for BRCM 4335 data stall"
    ...
    const-string v2, "set WFDAudioStart to true"
    ...
    invoke-static {v0}, Lcom/android/server/display/WifiDisplayController;->access$1900(Lcom/android/server/display/WifiDisplayController;)Landroid/media/AudioManager;

    move-result-object v0

    const-string v2, "WFDAudioStart=true"
    ...
    invoke-static {v0, v4}, Lcom/android/server/display/WifiDisplayController;->access$2102(Lcom/android/server/display/WifiDisplayController;Z)Z
...
.method public onDisplayDisconnected()V
    ...
    const-string v1, "set wifi.miracastlock to 0 for onDisplayDisconnected case"
...
.method public onDisplayError(I)V
    ...
    const-string v1, "onDisplayError"

    invoke-static {v0, v1}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v0, "WifiDisplayController"

    const-string v1, "set wifi.miracastlock to 0 for onDisplayError case"

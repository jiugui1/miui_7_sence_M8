...
.field public static final DFS_CHANNELS:[I
...
.field private static iface:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/display/WifiDisplayController;->iface:Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/server/display/WifiDisplayController;->DFS_CHANNELS:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/display/WifiDisplayController$Listener;)V
    ...
    sget-object v4, Lcom/android/server/display/WifiDisplayController;->iface:Ljava/lang/String;

    invoke-direct {v3, v4}, Landroid/net/wifi/WifiNative;-><init>(Ljava/lang/String;)V

    iput-object v3, p0, Lcom/android/server/display/WifiDisplayController;->mWifiNative:Landroid/net/wifi/WifiNative;
    ...
    invoke-virtual {v1, v3, v6, v2}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V

    new-instance v3, Landroid/net/wifi/WifiCustomizeReader;

    invoke-direct {v3}, Landroid/net/wifi/WifiCustomizeReader;-><init>()V

    iput-object v3, p0, Lcom/android/server/display/WifiDisplayController;->mWifiCustomizeReader:Landroid/net/wifi/WifiCustomizeReader;

    const-string v3, "WifiDisplayController"

    const-string v4, "Set Settings.Global.WIFI_DISPLAY_ON to 1 when we init WifiDisplayController"
...
.method static synthetic access$1900(Lcom/android/server/display/WifiDisplayController;)Landroid/media/AudioManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayController;
...
.method private connect(Landroid/net/wifi/p2p/WifiP2pDevice;)V
    ...
    const-string v2, "set mDesiredDevice to device in connect(), device ="
...
.method private disconnect()V
    ...
    const-string v1, "set mDesiredDevice to null in disconnect()"

    invoke-static {v0, v1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    const-string v0, "WifiDisplayController"

    const-string v1, "set wifi.miracastlock to 0 for disconnect case"

    invoke-static {v0, v1}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v0, "wifi.miracastlock"

    const-string v1, "0"

    invoke-static {v0, v1}, Landroid/os/SystemProperties;->set(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "wifi.miracaston"
...
.method private handleConnectionFailure(Z)V
    ...
    const-string v2, "set wifi.miracastlock to 0 for connection failure case"

    invoke-static {v1, v2}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v1, "wifi.miracastlock"

    const-string v2, "0"

    invoke-static {v1, v2}, Landroid/os/SystemProperties;->set(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "wifi.miracaston"
...
.method private isConnectToDfsChannels()Z
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/display/WifiDisplayController;->getAphFrequency(Landroid/net/wifi/WifiInfo;)I
    ...
    sget-object v0, Lcom/android/server/display/WifiDisplayController;->DFS_CHANNELS:[I
...
.method private retryConnection()V
    ...
    const-string v1, "set mDesiredDevice to new WifiP2pDevice(mDesiredDevice) in retryConnection()"
...
.method private setRemoteSubmixOn(Z)V
    ...
    const-string v1, "Ignore setRemoteSubmixOn"
...
.method private stopdiscoverPeers()V
    ...
    const-string v2, "Stop discover peers, mDiscoverPeersInProgress: "
    ...
    const-string v1, "Always stop discover peers"

    invoke-static {v0, v1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct {p0}, Lcom/android/server/display/WifiDisplayController;->tryStopDiscoverPeers()V
...
.method private tryStopDiscoverPeers()V
    .locals 3
...
.method private updateConnection()V
    ...
    const-string v4, "updateConnection enter step 1"
    ...
    const-string v4, "set WFDAudioStart to true"

    invoke-static {v0, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController;->mAudioManager:Landroid/media/AudioManager;

    const-string v4, "WFDAudioStart=true"

    invoke-virtual {v0, v4}, Landroid/media/AudioManager;->setParameters(Ljava/lang/String;)V

    const-string v0, "WifiDisplayController"

    const-string v4, "Disable Miracast mode in driver"

    invoke-static {v0, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController;->mWifiNative:Landroid/net/wifi/WifiNative;

    invoke-virtual {v0, v3}, Landroid/net/wifi/WifiNative;->setMiracast(Z)V
    ...
    const-string v3, "updateConnection enter step 2"
    ...
    const-string v5, "mConnectingDevice = "
    ...
    const-string v5, ",  mDesiredDevice = "
    ...
    const-string v4, "updateConnection enter step 3"
    ...
    const-string v4, "set mConnectingDevice to null in updateConnection, canceling connection"
    ...
    const-string v2, "Disable Miracast mode in driver"
    ...
    const-string v2, "updateConnection enter step 4"
    ...
    const-string v4, "updateConnection enter step 5"
    ...
    const-string v5, "set mConnectingDevice to mDesiredDevice:"
    ...
    const-string v4, "set wifi.miracastlock to 1"
    ...
    const-string v4, "Enable Miracast mode in driver"

    invoke-static {v0, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController;->mWifiNative:Landroid/net/wifi/WifiNative;

    invoke-virtual {v0, v14}, Landroid/net/wifi/WifiNative;->setMiracast(Z)V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/net/wifi/p2p/WifiP2pManager;->setWifiDisplayUnscan(Landroid/net/wifi/p2p/WifiP2pManager$Channel;Landroid/net/wifi/p2p/WifiP2pManager$ActionListener;)V

    invoke-direct {p0}, Lcom/android/server/display/WifiDisplayController;->isConnectToDfsChannels()Z
    ...
    const-string v2, "Wifi connect to AP in DFS channel, NOT disconnect wifi before configuration!"
    ...
    invoke-direct {v3, p0, v9}, Lcom/android/server/display/WifiDisplayController$16;-><init>(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pDevice;)V
    ...
    const-string v2, "not DFS channel"
    ...
    const-string v2, "updateConnection enter step 6"
    ...
    const-string v2, "set WFDAudioStart to false"

    invoke-static {v0, v2}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController;->mAudioManager:Landroid/media/AudioManager;

    const-string v2, "WFDAudioStart=false"
    ...
    invoke-direct {v0, p0, v10}, Lcom/android/server/display/WifiDisplayController$17;-><init>(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pDevice;)V
...
.method private updateWfdEnableState()V
    ...
    const-string v3, "updateWfdEnableState, mWifiDisplayOnSetting: "

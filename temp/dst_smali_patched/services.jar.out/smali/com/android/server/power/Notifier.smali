...
.field private mHtcPMSExtension:Lcom/android/server/power/HtcPMSExtension;
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/internal/app/IBatteryStats;Lcom/android/internal/app/IAppOpsService;Lcom/android/server/power/SuspendBlocker;Lcom/android/server/power/ScreenOnBlocker;Landroid/view/WindowManagerPolicy;Lcom/android/server/power/HtcPMSExtension;)V
    ...
    .param p8, "htcPMSExtension"    # Lcom/android/server/power/HtcPMSExtension;
    ...
    iput-object p8, p0, Lcom/android/server/power/Notifier;->mHtcPMSExtension:Lcom/android/server/power/HtcPMSExtension;
...
.method static synthetic access$1000(Lcom/android/server/power/Notifier;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/Notifier;
...
.method static synthetic access$900(Lcom/android/server/power/Notifier;)Ljava/lang/Runnable;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/Notifier;
...
.method private requestHideWeatherWallpaper()V
    .locals 2
...
.method private sendGoToSleepBroadcast(I)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/power/Notifier;->startMonitorFunction(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-direct {p0, v0}, Lcom/android/server/power/Notifier;->endMonitorFunction(Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Lcom/android/server/power/Notifier;->requestHideWeatherWallpaper()V
    ...
    const-string v2, "RemoteException caught: ActivityManagerNative.getDefault().goingToSleep(): "
    ...
    invoke-direct {p0, v1}, Lcom/android/server/power/Notifier;->endMonitorFunction(Ljava/lang/String;)V
...
.method private sendWakeUpBroadcast()V
    ...
    invoke-virtual {p0, v5}, Lcom/android/server/power/Notifier;->sendScreenOnOffIntent(Z)V
    ...
    const-string v2, "RemoteException caught: ActivityManagerNative.getDefault().wakingUp(): "
...
.method public doKeyguard()V
    ...
    const-string v2, "doKeyguard"

    invoke-static {v1, v2}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_0
    :try_start_0
    iget-object v1, p0, Lcom/android/server/power/Notifier;->mPolicy:Landroid/view/WindowManagerPolicy;

    invoke-interface {v1}, Landroid/view/WindowManagerPolicy;->doKeyguard()V
    :try_end_0

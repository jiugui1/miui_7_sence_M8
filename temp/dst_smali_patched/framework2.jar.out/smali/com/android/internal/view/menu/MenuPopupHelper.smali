...
.field private mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/view/menu/MenuBuilder;Landroid/view/View;Z)V
    ...
    iput-boolean v2, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->enableHtcPopup:Z
    ...
    iput v2, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mDropDownVerticalOffset:I
...
.method public dismiss()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;

    invoke-interface {v0}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->isShowing()Z
    ...
    invoke-interface {v0}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->internalDismiss()V
    ...
    invoke-interface {v0}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->dismissWithoutAnimation()V
...
.method public isShowing()Z
    ...
    iget-object v2, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;

    if-eqz v2, :cond_1

    iget-object v2, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;

    invoke-interface {v2}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->isShowing()Z
...
.method public onDismiss()V
    ...
    :cond_1
    iput-object v1, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;
...
.method public onGlobalLayout()V
    ...
    iget-object v1, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;

    invoke-interface {v1}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->show()V
...
.method public setListMenuOnTouchListener(Landroid/view/View$OnTouchListener;)V
    ...
    invoke-interface {v0}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->getListView()Landroid/view/View;
...
.method public setVerticalOffset(I)V
    ...
    .prologue
    iput p1, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mDropDownVerticalOffset:I
...
.method public tryShow()Z
    ...
    invoke-static {v2}, Lcom/htc/internal/widget/HtcPopupFactory;->getHtcPopupBubble(Landroid/content/Context;)Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;

    move-result-object v2

    iput-object v2, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;

    iget-object v2, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;

    invoke-interface {v2, p0}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->setOnItemClickListener(Ljava/lang/Object;)V

    iget-object v2, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;

    invoke-interface {v2, p0}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    invoke-interface {v2, v4}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->setAdapter(Landroid/widget/ListAdapter;)V

    iget-object v2, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;

    invoke-interface {v2, v3}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->setModal(Z)V
    ...
    invoke-interface {v2, v1}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->setAnchorView(Landroid/view/View;)V
    ...
    iput-boolean v3, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mHasContentWidth:Z
    ...
    iget v5, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->htcPopupWindowWidth:I

    invoke-static {v4, v5}, Ljava/lang/Math;->max(II)I

    move-result v4

    invoke-interface {v2, v4}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->setContentWidth(I)V

    iget-object v2, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;

    invoke-interface {v2, v7}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->setInputMethodMode(I)V

    iget-object v2, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mAdapter:Lcom/android/internal/view/menu/MenuPopupHelper$MenuAdapter;

    invoke-virtual {v2}, Lcom/android/internal/view/menu/MenuPopupHelper$MenuAdapter;->getCount()I
    ...
    invoke-interface {v2}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->show()V

    instance-of v2, v1, Lcom/android/internal/view/menu/ActionMenuItemView;
    ...
    invoke-virtual {v2, v3}, Lcom/android/internal/view/menu/ActionMenuItemView;->setMultiplyForceEnabled(Z)V

    :cond_3
    instance-of v2, v1, Lcom/android/internal/view/menu/OverflowMenuView;

    if-eqz v2, :cond_4

    move-object v2, v1

    check-cast v2, Lcom/android/internal/view/menu/OverflowMenuView;

    invoke-virtual {v2, v3}, Lcom/android/internal/view/menu/OverflowMenuView;->setMultiplyForceEnabled(Z)V

    :cond_4
    iget-object v2, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopupSpecial:Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;

    invoke-interface {v2}, Lcom/htc/internal/widget/HtcPopupFactory$HtcPopupBubble;->getListView()Landroid/view/View;
    ...
    iget-object v4, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->onTouchListener:Landroid/view/View$OnTouchListener;
    ...
    invoke-direct {v2, v4, v5, v6}, Landroid/widget/ListPopupWindow;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v2, v4}, Landroid/widget/ListPopupWindow;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    iget v4, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mDropDownVerticalOffset:I
    ...
    invoke-virtual {v2, v4}, Landroid/widget/ListPopupWindow;->setContentWidth(I)V

    iget-object v2, p0, Lcom/android/internal/view/menu/MenuPopupHelper;->mPopup:Landroid/widget/ListPopupWindow;

    invoke-virtual {v2, v7}, Landroid/widget/ListPopupWindow;->setInputMethodMode(I)V

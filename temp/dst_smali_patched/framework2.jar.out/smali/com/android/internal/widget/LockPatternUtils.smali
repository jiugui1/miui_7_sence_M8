...
.method public getPasswordHistory()I
    ...
    invoke-virtual {v0, v1, v2}, Landroid/app/admin/DevicePolicyManager;->getPasswordHistory(Landroid/content/ComponentName;I)I
...
.method public isLockFingerprintEnabled()Z
    ...
    sget v3, Lcom/android/internal/widget/LockPatternUtils;->PASSWORD_QUALITY_FINGERPRINT:I
...
.method public saveLockPassword(Ljava/lang/String;IZI)V
    ...
    sput v4, Lcom/android/internal/widget/LockPatternUtils;->mPasswordLength:I
    ...
    invoke-virtual/range {v3 .. v14}, Landroid/app/admin/DevicePolicyManager;->htcSetActivePasswordState(IIIIIIIIIZI)V
    ...
    .end local v12    # "numberOfComplexGroup":I
    .end local v13    # "isSimple":Z
    .end local v27    # "i":I
    :goto_2
    ...
    .restart local v12    # "numberOfComplexGroup":I
    .restart local v13    # "isSimple":Z

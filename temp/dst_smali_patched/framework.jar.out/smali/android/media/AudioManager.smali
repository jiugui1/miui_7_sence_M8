...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/media/AudioManager$RccEventHandlerDelegate;,
        Landroid/media/AudioManager$OnRccChangeListener;,
...
.field private mOnRccChangeListener:Landroid/media/AudioManager$OnRccChangeListener;

.field private final mRccEventDispatcher:Landroid/media/IRccEventDispatcher;

.field private final mRccEventHandlerDelegate:Landroid/media/AudioManager$RccEventHandlerDelegate;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v0, Landroid/media/AudioManager$RccEventHandlerDelegate;

    invoke-direct {v0, p0}, Landroid/media/AudioManager$RccEventHandlerDelegate;-><init>(Landroid/media/AudioManager;)V

    iput-object v0, p0, Landroid/media/AudioManager;->mRccEventHandlerDelegate:Landroid/media/AudioManager$RccEventHandlerDelegate;
    ...
    iput-object v0, p0, Landroid/media/AudioManager;->mRccEventDispatcher:Landroid/media/IRccEventDispatcher;
...
.method static synthetic access$300(Landroid/media/AudioManager;)Landroid/media/AudioManager$OnRccChangeListener;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioManager;

    .prologue
    iget-object v0, p0, Landroid/media/AudioManager;->mOnRccChangeListener:Landroid/media/AudioManager$OnRccChangeListener;
...
.method static synthetic access$500(Landroid/media/AudioManager;)Landroid/media/AudioManager$RccEventHandlerDelegate;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioManager;

    .prologue
    iget-object v0, p0, Landroid/media/AudioManager;->mRccEventHandlerDelegate:Landroid/media/AudioManager$RccEventHandlerDelegate;
...
.method public adjustLocalOrRemoteStreamVolumeWithFlags(III)V
    ...
    invoke-interface {v1, p1, p2, p3, v2}, Landroid/media/IAudioService;->adjustLocalOrRemoteStreamVolumeWithFlags(IIILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public applyFullVolumeSetting([Ljava/lang/String;)V
    .locals 0
...
.method public applyVolumeSetting([I)V
    .locals 0
    .param p1, "volumeSettings"    # [I
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method public getDeviceForStream(I)I
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->getDeviceForStream(I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getVolumeSetting()[I
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method public lockMusicVolumeToMax(Z)V
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->lockMusicVolumeToMax(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public registerRemoteControlClient(Landroid/media/RemoteControlClient;)V
    ...
    invoke-virtual {p1, v3}, Landroid/media/RemoteControlClient;->setPackageName(Ljava/lang/String;)V
...
.method public setEnforceShutterSoundOn(Z)V
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->setEnforceShutterSoundOn(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in setEnforceShutterSoundOn"
...
.method public setRccListener(Landroid/media/AudioManager$OnRccChangeListener;)V
    .locals 4
    .param p1, "listener"    # Landroid/media/AudioManager$OnRccChangeListener;

    .prologue
    sget-object v2, Landroid/media/AudioManager;->TAG:Ljava/lang/String;

    const-string v3, "[RccEvent]setRccListener"

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iput-object p1, p0, Landroid/media/AudioManager;->mOnRccChangeListener:Landroid/media/AudioManager$OnRccChangeListener;
    ...
    iget-object v2, p0, Landroid/media/AudioManager;->mOnRccChangeListener:Landroid/media/AudioManager$OnRccChangeListener;

    if-eqz v2, :cond_0

    iget-object v2, p0, Landroid/media/AudioManager;->mRccEventDispatcher:Landroid/media/IRccEventDispatcher;

    invoke-interface {v1, v2}, Landroid/media/IAudioService;->setRccEventDispatcher(Landroid/media/IRccEventDispatcher;)V

    :goto_0
    sget-object v2, Landroid/media/AudioManager;->TAG:Ljava/lang/String;

    const-string v3, "--setRccListener"
    ...
    const-string v3, "[RccEvnet]Dead object in setRccListener"

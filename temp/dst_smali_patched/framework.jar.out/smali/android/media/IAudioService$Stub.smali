...
.field static final TRANSACTION_abandonFixedDLNAVolume:I = 0x71

.field static final TRANSACTION_adjustLocalOrRemoteStreamVolume:I = 0x4

.field static final TRANSACTION_adjustLocalOrRemoteStreamVolumeWithFlags:I = 0x4b
...
.field static final TRANSACTION_applyVolumeSetting:I = 0x66
...
.field static final TRANSACTION_forceSoundEffect:I = 0x56

.field static final TRANSACTION_forceVolumeControlStream:I = 0x43

.field static final TRANSACTION_getBeatsHeadset:I = 0x5d

.field static final TRANSACTION_getBeatsState:I = 0x50

.field static final TRANSACTION_getCurrentAudioFocus:I = 0x2c

.field static final TRANSACTION_getDeviceForStream:I = 0x68

.field static final TRANSACTION_getDeviceVolume:I = 0x65

.field static final TRANSACTION_getEffectManagerProperty:I = 0x73

.field static final TRANSACTION_getFullVolumeSetting:I = 0x6b

.field static final TRANSACTION_getGlobalEffect:I = 0x55
...
.field static final TRANSACTION_getNotificationUseRingVolume:I = 0x6c

.field static final TRANSACTION_getRccEventDispatcher:I = 0x6f
...
.field static final TRANSACTION_getSoundEffect:I = 0x58
...
.field static final TRANSACTION_getVolumeSetting:I = 0x67

.field static final TRANSACTION_isBeatsHeadset:I = 0x53

.field static final TRANSACTION_isBeatsHeadsetBT:I = 0x5b
...
.field static final TRANSACTION_isDongleConnected:I = 0x61

.field static final TRANSACTION_isFMActive:I = 0x5c
...
.field static final TRANSACTION_lockMusicVolumeToMax:I = 0x69

.field static final TRANSACTION_lockMusicVolumeUI:I = 0x6a

.field static final TRANSACTION_notifyVideoEvent:I = 0x59

.field static final TRANSACTION_playSoundEffect:I = 0x1d

.field static final TRANSACTION_playSoundEffectVolume:I = 0x1e

.field static final TRANSACTION_queryGlobalEffectList:I = 0x5a
...
.field static final TRANSACTION_requestFixedDLNAVolume:I = 0x70

.field static final TRANSACTION_restoreEffect:I = 0x52

.field static final TRANSACTION_restoreSoundEffect:I = 0x57

.field static final TRANSACTION_setBeatsState:I = 0x4f
...
.field static final TRANSACTION_setCSCallVolumeOn:I = 0x4d

.field static final TRANSACTION_setDeviceVolume:I = 0x64

.field static final TRANSACTION_setEffectManagerProperty:I = 0x74

.field static final TRANSACTION_setEnforceShutterSoundOn:I = 0x63

.field static final TRANSACTION_setGlobalEffect:I = 0x54

.field static final TRANSACTION_setHtcSpecificAPdefault:I = 0x5e

.field static final TRANSACTION_setIgnoreNotificationMuteSetting:I = 0x4e
...
.field static final TRANSACTION_setNotificationUseRingVolume:I = 0x6d

.field static final TRANSACTION_setPlaybackInfoForRcc:I = 0x3c

.field static final TRANSACTION_setPlaybackStateForRcc:I = 0x3d

.field static final TRANSACTION_setRccEventDispatcher:I = 0x6e
...
.field static final TRANSACTION_setStreamLastaudibleIndex:I = 0x5f
...
.field static final TRANSACTION_setVolumePanelOrientation:I = 0x4c

.field static final TRANSACTION_setVolumePanelParameters:I = 0x62
...
.field static final TRANSACTION_triggerBeatsLogo:I = 0x51

.field static final TRANSACTION_triggerBecomingNoisyIntent:I = 0x72
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {v0, v4, v5, v6, v7}, Landroid/media/IAudioService$Stub;->adjustLocalOrRemoteStreamVolumeWithFlags(IIILjava/lang/String;)V
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->setVolumePanelOrientation(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->setCSCallVolumeOn(Z)V
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->setIgnoreNotificationMuteSetting(Z)V
    ...
    invoke-virtual {v0, v4, v5}, Landroid/media/IAudioService$Stub;->setBeatsState(ZLjava/lang/String;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->getBeatsState()Z
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->triggerBeatsLogo(Z)V
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->restoreEffect(Z)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->isBeatsHeadset()Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->queryGlobalEffectList()[I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->isBeatsHeadsetBT()Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->setHtcSpecificAPdefault()V
    ...
    invoke-virtual {v0, v4, v5}, Landroid/media/IAudioService$Stub;->setStreamLastaudibleIndex(II)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->isHeadsetPlugged()Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->isDongleConnected()Z
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->setVolumePanelParameters(Ljava/util/Map;)V
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->setEnforceShutterSoundOn(Z)V
    ...
    invoke-virtual {v0, v4, v5, v6}, Landroid/media/IAudioService$Stub;->setDeviceVolume(III)V
    ...
    invoke-virtual {v0, v4, v5}, Landroid/media/IAudioService$Stub;->getDeviceVolume(II)I
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->applyVolumeSetting([Ljava/lang/String;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->getVolumeSetting()[Ljava/lang/String;
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->getDeviceForStream(I)I
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->lockMusicVolumeToMax(Z)V
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->lockMusicVolumeUI(Z)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->getFullVolumeSetting()[Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->getNotificationUseRingVolume()I
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->setNotificationUseRingVolume(I)V
    ...
    invoke-static {v3}, Landroid/media/IRccEventDispatcher$Stub;->asInterface(Landroid/os/IBinder;)Landroid/media/IRccEventDispatcher;

    move-result-object v4

    .local v4, "_arg0":Landroid/media/IRccEventDispatcher;
    move-object/from16 v0, p0

    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->setRccEventDispatcher(Landroid/media/IRccEventDispatcher;)V
    ...
    .end local v4    # "_arg0":Landroid/media/IRccEventDispatcher;
    :sswitch_6f
    const-string v3, "android.media.IAudioService"
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->getRccEventDispatcher()Landroid/media/IRccEventDispatcher;

    move-result-object v18

    .local v18, "_result":Landroid/media/IRccEventDispatcher;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V

    if-eqz v18, :cond_2f

    invoke-interface/range {v18 .. v18}, Landroid/media/IRccEventDispatcher;->asBinder()Landroid/os/IBinder;
    ...
    .end local v18    # "_result":Landroid/media/IRccEventDispatcher;
    :sswitch_70
    const-string v3, "android.media.IAudioService"
    ...
    invoke-virtual {v0, v4, v5}, Landroid/media/IAudioService$Stub;->requestFixedDLNAVolume(Landroid/os/IBinder;I)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->abandonFixedDLNAVolume()V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/IAudioService$Stub;->triggerBecomingNoisyIntent()V
    ...
    invoke-virtual {v0, v4}, Landroid/media/IAudioService$Stub;->getEffectManagerProperty(I)I
    ...
    invoke-virtual {v0, v4, v5}, Landroid/media/IAudioService$Stub;->setEffectManagerProperty(II)V

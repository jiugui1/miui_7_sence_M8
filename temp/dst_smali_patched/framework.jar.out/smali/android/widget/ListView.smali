...
.field private static final NONSENSITIVE_FACTOR:I = 0x6
...
.field mClickAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.field mFillDividerHeight:I

.field mFillEmptySpace:Z
...
.field mLightDivider:Landroid/graphics/drawable/ColorDrawable;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v10, p0, Landroid/widget/ListView;->mHeaderViewInfos:Ljava/util/ArrayList;

    invoke-static {}, Lcom/google/android/collect/Lists;->newArrayList()Ljava/util/ArrayList;

    move-result-object v10

    iput-object v10, p0, Landroid/widget/ListView;->mFooterViewInfos:Ljava/util/ArrayList;
    ...
    iput-boolean v10, p0, Landroid/widget/ListView;->mItemsCanFocus:Z

    new-instance v10, Landroid/graphics/Rect;

    invoke-direct {v10}, Landroid/graphics/Rect;-><init>()V

    iput-object v10, p0, Landroid/widget/ListView;->mTempRect:Landroid/graphics/Rect;

    new-instance v10, Landroid/widget/ListView$ArrowScrollFocusResult;

    const/4 v11, 0x0

    invoke-direct {v10, v11}, Landroid/widget/ListView$ArrowScrollFocusResult;-><init>(Landroid/widget/ListView$1;)V

    iput-object v10, p0, Landroid/widget/ListView;->mArrowScrollFocusResult:Landroid/widget/ListView$ArrowScrollFocusResult;

    const/4 v10, 0x1

    iput-boolean v10, p0, Landroid/widget/ListView;->mShouldDrawPressShadow:Z

    const/4 v10, 0x0

    iput-boolean v10, p0, Landroid/widget/ListView;->m2DPressAnimationEnabled:Z

    const/high16 v10, 0x41200000    # 10.0f

    iput v10, p0, Landroid/widget/ListView;->mScaleXDifference:F

    const/high16 v10, 0x41200000    # 10.0f

    iput v10, p0, Landroid/widget/ListView;->mScaleYDifference:F

    const v10, 0x3f666666    # 0.9f

    iput v10, p0, Landroid/widget/ListView;->mClickAnimationScaleX:F

    const v10, 0x3f666666    # 0.9f

    iput v10, p0, Landroid/widget/ListView;->mClickAnimationScaleY:F

    const/4 v10, -0x1

    iput v10, p0, Landroid/widget/ListView;->mOverScrollShadowHeight:I

    new-instance v10, Ljava/util/ArrayList;

    invoke-direct {v10}, Ljava/util/ArrayList;-><init>()V

    iput-object v10, p0, Landroid/widget/ListView;->mPressedViews:Ljava/util/ArrayList;

    new-instance v10, Ljava/util/HashMap;

    invoke-direct {v10}, Ljava/util/HashMap;-><init>()V

    iput-object v10, p0, Landroid/widget/ListView;->mPressAnimators:Ljava/util/Map;

    const/4 v10, 0x0

    iput-boolean v10, p0, Landroid/widget/ListView;->mFillEmptySpace:Z

    const/4 v10, 0x2

    iput v10, p0, Landroid/widget/ListView;->mFillDividerHeight:I

    const/4 v10, 0x0

    iput-boolean v10, p0, Landroid/widget/ListView;->mSame:Z

    const/4 v10, 0x0

    iput-boolean v10, p0, Landroid/widget/ListView;->mInBouncing:Z

    const/4 v10, 0x0

    iput-object v10, p0, Landroid/widget/ListView;->mPressedView:Landroid/view/View;

    const/16 v10, 0x3c

    iput v10, p0, Landroid/widget/ListView;->mReleaseAnimationDuration:I

    const-wide/16 v10, 0x64

    iput-wide v10, p0, Landroid/widget/ListView;->mCheckForPressAnimationDelay:J

    new-instance v10, Landroid/widget/ListView$2;

    invoke-direct {v10, p0}, Landroid/widget/ListView$2;-><init>(Landroid/widget/ListView;)V

    iput-object v10, p0, Landroid/widget/ListView;->mAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    new-instance v10, Landroid/widget/ListView$3;

    invoke-direct {v10, p0}, Landroid/widget/ListView$3;-><init>(Landroid/widget/ListView;)V

    iput-object v10, p0, Landroid/widget/ListView;->mClickAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    sget-object v10, Lcom/android/internal/R$styleable;->ListView:[I
    ...
    invoke-direct {v10, p1, v11, v5}, Landroid/widget/ArrayAdapter;-><init>(Landroid/content/Context;I[Ljava/lang/Object;)V

    invoke-virtual {p0, v10}, Landroid/widget/ListView;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .local v8, "osHeader":Landroid/graphics/drawable/Drawable;
    if-eqz v8, :cond_2

    invoke-virtual {p0, v8}, Landroid/widget/ListView;->setOverscrollHeader(Landroid/graphics/drawable/Drawable;)V
    ...
    .local v7, "osFooter":Landroid/graphics/drawable/Drawable;
    if-eqz v7, :cond_3

    invoke-virtual {p0, v7}, Landroid/widget/ListView;->setOverscrollFooter(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v10, p0, Landroid/widget/ListView;->mHeaderDividersEnabled:Z
    ...
    iput-boolean v10, p0, Landroid/widget/ListView;->mFooterDividersEnabled:Z
    ...
    iput-object v10, p0, Landroid/widget/ListView;->mLightDivider:Landroid/graphics/drawable/ColorDrawable;
    :try_end_0
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_1

    :goto_0
    const-string v10, "common_list_item_background"

    const v11, 0x208003b

    invoke-static {p1, v10, v11}, Landroid/widget/HtcSkinUtil;->getDrawableResIdentifier(Landroid/content/Context;Ljava/lang/String;I)I

    move-result v6

    .local v6, "itemBackgroundResId":I
    if-lez v6, :cond_6
    ...
    instance-of v10, v1, Landroid/graphics/drawable/LayerDrawable;
    ...
    invoke-virtual {v1, v10}, Landroid/graphics/drawable/LayerDrawable;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v10

    iput-object v10, p0, Landroid/widget/ListView;->mItemBackground:Landroid/graphics/drawable/Drawable;
    ...
    iput v10, p0, Landroid/widget/ListView;->mMaxOverFlingGap:I
    ...
    iput v10, p0, Landroid/widget/ListView;->mMinOverFlingGap:I
    :try_end_1
    ...
    const-string v11, "Resource id com.htc.internal.R.dimen.listview_max_overfling_gap or com.htc.internal.R.dimen.listview_min_overfling_gap is not found"
    ...
    .end local v6    # "itemBackgroundResId":I
    :catch_1
    move-exception v10
...
.method static synthetic access$702(Landroid/widget/ListView;Z)Z
    .locals 0
    .param p0, "x0"    # Landroid/widget/ListView;
    .param p1, "x1"    # Z

    .prologue
    iput-boolean p1, p0, Landroid/widget/ListView;->mInBouncing:Z
...
.method private get2DPressAnimation(Landroid/view/View;)Landroid/animation/ObjectAnimator;
    ...
    iget-object v7, p0, Landroid/widget/ListView;->mClickAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method private get2DReleaseAnimation(Landroid/view/View;Z)Landroid/animation/ObjectAnimator;
    ...
    iget-object v8, p0, Landroid/widget/ListView;->mClickAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual/range {v46 .. v46}, Landroid/view/View;->getTranslationY()F
    ...
    invoke-virtual/range {v46 .. v46}, Landroid/view/View;->getBottom()I
    ...
    .local v35, "nextChild":Landroid/view/View;
    if-nez v10, :cond_c

    .end local v10    # "child":Landroid/view/View;
    .end local v11    # "childCount":I
    .end local v25    # "i":I
    .end local v35    # "nextChild":Landroid/view/View;
    .end local v43    # "shadowHeight":I
    :cond_2
    move-object/from16 v0, p0
    ...
    .local v38, "overscrollFooter":Landroid/graphics/drawable/Drawable;
    if-eqz v39, :cond_f
    ...
    iget-object v6, v0, Landroid/widget/ListView;->mAdapter:Landroid/widget/ListAdapter;
    ...
    invoke-virtual/range {v46 .. v47}, Landroid/graphics/Paint;->setColor(I)V
    ...
    .end local v10    # "child":Landroid/view/View;
    .end local v29    # "isLastItem":Z
    .end local v36    # "nextIndex":I
    :cond_b
    :goto_a
    ...
    .end local v30    # "itemCount":I
    .end local v31    # "itemIndex":I
    .end local v34    # "listBottom":I
    .end local v38    # "overscrollFooter":Landroid/graphics/drawable/Drawable;
    .end local v39    # "overscrollHeader":Landroid/graphics/drawable/Drawable;
    .end local v40    # "paint":Landroid/graphics/Paint;
    .end local v42    # "scrollY":I
    .restart local v10    # "child":Landroid/view/View;
    .restart local v11    # "childCount":I
    .restart local v35    # "nextChild":Landroid/view/View;
    .restart local v43    # "shadowHeight":I
    :cond_c
    const/16 v43, 0x0
    ...
    invoke-virtual/range {v47 .. v47}, Landroid/view/View;->getTranslationY()F
    ...
    .restart local v38    # "overscrollFooter":Landroid/graphics/drawable/Drawable;
    ...
    .restart local v21    # "footerDividers":Z
    .restart local v22    # "footerLimit":I
    .restart local v23    # "headerCount":I
    .restart local v24    # "headerDividers":Z
    .restart local v30    # "itemCount":I
    :cond_12
    const/16 v19, 0x0
    ...
    .restart local v34    # "listBottom":I
    .restart local v40    # "paint":Landroid/graphics/Paint;
    .restart local v42    # "scrollY":I
    :cond_13
    if-eqz v14, :cond_7
    ...
    .restart local v29    # "isLastItem":Z
    .restart local v36    # "nextIndex":I
    :cond_17
    if-nez v7, :cond_1b
    ...
    .end local v30    # "itemCount":I
    .end local v34    # "listBottom":I
    .end local v37    # "overFooterBottom":I
    .end local v40    # "paint":Landroid/graphics/Paint;
    .end local v42    # "scrollY":I
    :cond_1e
    :goto_b
    ...
    iget-boolean v0, v0, Landroid/widget/ListView;->mFillEmptySpace:Z
    ...
    .local v32, "lastChildView":Landroid/view/View;
    if-eqz v32, :cond_1f
    ...
    iget-object v0, v0, Landroid/widget/ListView;->mItemBackground:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v46 .. v50}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
    ...
    .local v33, "lastItemView":Landroid/view/View;
    if-eqz v33, :cond_20
    ...
    invoke-virtual/range {v33 .. v33}, Landroid/view/View;->getTranslationY()F
    ...
    iget-object v0, v0, Landroid/widget/ListView;->mLightDivider:Landroid/graphics/drawable/ColorDrawable;
    ...
    iget v0, v0, Landroid/widget/ListView;->mFillDividerHeight:I
    ...
    .end local v32    # "lastChildView":Landroid/view/View;
    .end local v33    # "lastItemView":Landroid/view/View;
    .end local v45    # "top":I
    :cond_20
    move-object/from16 v0, p0
    ...
    .restart local v41    # "previousIndex":I
    :cond_2f
    if-eqz v19, :cond_2a
...
.method public enableAnimation(IZ)V
    ...
    invoke-virtual {p0}, Landroid/widget/ListView;->isCLICKAnimationEnabled()Z

    move-result v2

    iput-boolean v2, p0, Landroid/widget/ListView;->m2DPressAnimationEnabled:Z

    iget-boolean v2, p0, Landroid/widget/ListView;->m2DPressAnimationEnabled:Z
    ...
    iget-object v2, p0, Landroid/widget/ListView;->mGestureDetector:Landroid/view/GestureDetector;

    if-nez v2, :cond_0

    new-instance v2, Landroid/widget/ListView$6;

    invoke-direct {v2, p0}, Landroid/widget/ListView$6;-><init>(Landroid/widget/ListView;)V

    iput-object v2, p0, Landroid/widget/ListView;->mGestureListener:Landroid/view/GestureDetector$OnGestureListener;
    ...
    iget-object v4, p0, Landroid/widget/ListView;->mGestureListener:Landroid/view/GestureDetector$OnGestureListener;

    invoke-direct {v2, v3, v4}, Landroid/view/GestureDetector;-><init>(Landroid/content/Context;Landroid/view/GestureDetector$OnGestureListener;)V

    iput-object v2, p0, Landroid/widget/ListView;->mGestureDetector:Landroid/view/GestureDetector;

    :cond_0
    iget-object v2, p0, Landroid/widget/ListView;->mPressShadowTopBottom:Landroid/graphics/drawable/Drawable;
    ...
    const-string v2, "common_rearrange_frame_bottom"
    ...
    iput-object v2, p0, Landroid/widget/ListView;->mPressShadowTopBottom:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/widget/ListView;->mOverScrollShadow:Landroid/graphics/drawable/Drawable;
    ...
    const-string v2, "common_list_shadow"
    ...
    iput-object v2, p0, Landroid/widget/ListView;->mOverScrollShadow:Landroid/graphics/drawable/Drawable;
    ...
    iput v2, p0, Landroid/widget/ListView;->mOverScrollShadowHeight:I
...
.method public fillEmptySpace(Z)V
    .locals 0
    .param p1, "fillEmptySpace"    # Z
    .annotation runtime Landroid/view/RemotableViewMethod;
    .end annotation

    .prologue
    iput-boolean p1, p0, Landroid/widget/ListView;->mFillEmptySpace:Z
...
.method onOverFling(Z)V
    .locals 12
    .param p1, "moveUp"    # Z

    .prologue
    invoke-super {p0, p1}, Landroid/widget/AbsListView;->onOverFling(Z)V

    invoke-direct {p0}, Landroid/widget/ListView;->cancelPressAnimation()V

    invoke-virtual {p0}, Landroid/widget/ListView;->getOverFlingGap()F

    move-result v5

    .local v5, "overflingGap":F
    new-instance v7, Landroid/animation/AnimatorSet;

    invoke-direct {v7}, Landroid/animation/AnimatorSet;-><init>()V

    iput-object v7, p0, Landroid/widget/ListView;->mOverFlingBouncing:Landroid/animation/AnimatorSet;

    iget-object v7, p0, Landroid/widget/ListView;->mOverFlingBouncing:Landroid/animation/AnimatorSet;

    iget-object v8, p0, Landroid/widget/ListView;->mOverFlingInterpolator:Landroid/view/animation/DecelerateInterpolator;

    invoke-virtual {v7, v8}, Landroid/animation/AnimatorSet;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object v7, p0, Landroid/widget/ListView;->mOverFlingBouncing:Landroid/animation/AnimatorSet;

    new-instance v8, Landroid/widget/ListView$7;

    invoke-direct {v8, p0}, Landroid/widget/ListView$7;-><init>(Landroid/widget/ListView;)V
    ...
    .local v6, "pvhTranslationY":Landroid/animation/PropertyValuesHolder;
    invoke-virtual {p0, v2}, Landroid/widget/ListView;->getChildAt(I)Landroid/view/View;
    ...
    .local v1, "childScaleTransAnim":Landroid/animation/ObjectAnimator;
    iget v7, p0, Landroid/widget/ListView;->mOverFlingBouncingDuration:I

    int-to-long v7, v7

    invoke-virtual {v1, v7, v8}, Landroid/animation/ObjectAnimator;->setDuration(J)Landroid/animation/ObjectAnimator;

    iget-object v7, p0, Landroid/widget/ListView;->mOverFlingInterpolator:Landroid/view/animation/DecelerateInterpolator;
    ...
    .end local v1    # "childScaleTransAnim":Landroid/animation/ObjectAnimator;
    .end local v6    # "pvhTranslationY":Landroid/animation/PropertyValuesHolder;
    :cond_2
    move v4, v2
    ...
    .restart local v6    # "pvhTranslationY":Landroid/animation/PropertyValuesHolder;
    invoke-virtual {p0, v2}, Landroid/widget/ListView;->getChildAt(I)Landroid/view/View;
    ...
    .restart local v1    # "childScaleTransAnim":Landroid/animation/ObjectAnimator;
    iget v7, p0, Landroid/widget/ListView;->mOverFlingBouncingDuration:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    invoke-virtual/range {p0 .. p0}, Landroid/widget/ListView;->isCLICKAnimationEnabled()Z
    ...
    iget-object v0, v0, Landroid/widget/ListView;->mAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

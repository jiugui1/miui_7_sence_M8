...
.method private getHandle()Landroid/widget/Editor$InsertionHandleView;
    ...
    invoke-static {v0}, Landroid/widget/Editor;->access$6500(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v2}, Lcom/htc/textselection/HtcTextSelectionManager;->getAnchorBarDrawableCenter(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    :goto_0
    # setter for: Landroid/widget/Editor;->mSelectHandleCenter:Landroid/graphics/drawable/Drawable;
    invoke-static {v1, v0}, Landroid/widget/Editor;->access$6502(Landroid/widget/Editor;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    # getter for: Landroid/widget/Editor;->mSelectHandleCenter:Landroid/graphics/drawable/Drawable;
    invoke-static {v2}, Landroid/widget/Editor;->access$6500(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
...
.method public showWithActionPopupDelay()V
    ...
    invoke-static {v0}, Landroid/widget/Editor$InsertionHandleView;->access$6400(Landroid/widget/Editor$InsertionHandleView;)V

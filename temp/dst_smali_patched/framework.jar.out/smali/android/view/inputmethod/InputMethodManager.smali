...
.field public static final HTC_IME_PACKAGE_NAME:Ljava/lang/String;
...
.field public static final sIsSense55:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/view/inputmethod/InputMethodManager;->sIsSense55:Z

    sget-boolean v0, Landroid/view/inputmethod/InputMethodManager;->sIsSense55:Z
    ...
    :goto_0
    sput-object v0, Landroid/view/inputmethod/InputMethodManager;->HTC_IME_PACKAGE_NAME:Ljava/lang/String;
    ...
    :cond_1
    const-string v0, "com.htc.sense.ime"
...
.method sendInputEventOnMainLooperLocked(Landroid/view/inputmethod/InputMethodManager$PendingEvent;)I
    ...
    iget-object v5, p0, Landroid/view/inputmethod/InputMethodManager;->mCurChannel:Landroid/view/InputChannel;

    if-eqz v5, :cond_3

    iget-object v5, p0, Landroid/view/inputmethod/InputMethodManager;->mCurSender:Landroid/view/inputmethod/InputMethodManager$ImeInputEventSender;

    if-nez v5, :cond_0

    new-instance v5, Landroid/view/inputmethod/InputMethodManager$ImeInputEventSender;

    iget-object v6, p0, Landroid/view/inputmethod/InputMethodManager;->mCurChannel:Landroid/view/InputChannel;

    iget-object v7, p0, Landroid/view/inputmethod/InputMethodManager;->mH:Landroid/view/inputmethod/InputMethodManager$H;

    invoke-virtual {v7}, Landroid/view/inputmethod/InputMethodManager$H;->getLooper()Landroid/os/Looper;

    move-result-object v7

    invoke-direct {v5, p0, v6, v7}, Landroid/view/inputmethod/InputMethodManager$ImeInputEventSender;-><init>(Landroid/view/inputmethod/InputMethodManager;Landroid/view/InputChannel;Landroid/os/Looper;)V

    iput-object v5, p0, Landroid/view/inputmethod/InputMethodManager;->mCurSender:Landroid/view/inputmethod/InputMethodManager$ImeInputEventSender;
    ...
    invoke-virtual {v5, v2, v0}, Landroid/view/inputmethod/InputMethodManager$ImeInputEventSender;->sendInputEvent(ILandroid/view/InputEvent;)Z
    ...
    iget-object v7, p0, Landroid/view/inputmethod/InputMethodManager;->mPendingEvents:Landroid/util/SparseArray;

    invoke-virtual {v7}, Landroid/util/SparseArray;->size()I

    move-result v7

    invoke-static {v4, v5, v6, v7}, Landroid/os/Trace;->traceCounter(JLjava/lang/String;I)V

    iget-object v4, p0, Landroid/view/inputmethod/InputMethodManager;->mH:Landroid/view/inputmethod/InputMethodManager$H;

    const/4 v5, 0x6

    invoke-virtual {v4, v5, p1}, Landroid/view/inputmethod/InputMethodManager$H;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v4, v1, v5, v6}, Landroid/view/inputmethod/InputMethodManager$H;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    const-string v6, "Unable to send input event to IME: "
    ...
    .end local v2    # "seq":I
    :cond_3
    iget-object v5, p1, Landroid/view/inputmethod/InputMethodManager$PendingEvent;->mEvent:Landroid/view/InputEvent;
    ...
    invoke-virtual {v6, v7, v2, v4, p1}, Landroid/view/inputmethod/InputMethodManager$H;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v4

    invoke-virtual {v5, v4}, Landroid/view/inputmethod/InputMethodManager$H;->sendMessage(Landroid/os/Message;)Z
    ...
    const-string v6, "Still handle event="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p1, Landroid/view/inputmethod/InputMethodManager$PendingEvent;->mEvent:Landroid/view/InputEvent;
...
.method startInputInner(Landroid/os/IBinder;III)Z
    ...
    const-string v2, "In startInputInner():"

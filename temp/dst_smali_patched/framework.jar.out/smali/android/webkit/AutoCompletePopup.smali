...
.field private mInputConnection:Landroid/webkit/WebViewClassic$WVInputConnection;
...
# direct methods
.method public constructor <init>(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewClassic$WVInputConnection;)V
    .locals 1
    .param p1, "webView"    # Landroid/webkit/WebViewClassic;
    .param p2, "inputConnection"    # Landroid/webkit/WebViewClassic$WVInputConnection;

    .prologue
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Landroid/webkit/AutoCompletePopup;->mInputConnection:Landroid/webkit/WebViewClassic$WVInputConnection;
...
.method private pushTextToInputConnection()V
    ...
    .prologue
    iget-object v1, p0, Landroid/webkit/AutoCompletePopup;->mInputConnection:Landroid/webkit/WebViewClassic$WVInputConnection;
    ...
    invoke-virtual {v1, v2, v3}, Landroid/webkit/WebViewClassic$WVInputConnection;->setSelection(II)Z

    iget-object v1, p0, Landroid/webkit/AutoCompletePopup;->mInputConnection:Landroid/webkit/WebViewClassic$WVInputConnection;

    iget-object v2, p0, Landroid/webkit/AutoCompletePopup;->mText:Ljava/lang/CharSequence;

    invoke-virtual {v1, v2}, Landroid/webkit/WebViewClassic$WVInputConnection;->replaceSelection(Ljava/lang/CharSequence;)V
...
.method public onFilterComplete(I)V
    ...
    iget-object v3, p0, Landroid/webkit/AutoCompletePopup;->mInputConnection:Landroid/webkit/WebViewClassic$WVInputConnection;

    invoke-virtual {v3}, Landroid/webkit/WebViewClassic$WVInputConnection;->getIsAutoFillable()Z
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object v2, p0, Landroid/webkit/AutoCompletePopup;->mInputConnection:Landroid/webkit/WebViewClassic$WVInputConnection;

    invoke-virtual {v2}, Landroid/webkit/WebViewClassic$WVInputConnection;->getIsAutoFillable()Z

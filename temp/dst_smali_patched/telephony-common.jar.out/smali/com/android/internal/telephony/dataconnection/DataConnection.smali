...
.field private static final mDualCardProject:Z

.field protected static mIgnoreDNSCheckMCCList:Ljava/lang/String;

.field private static mInstanceNumber:Ljava/util/concurrent/atomic/AtomicInteger;

.field protected static mInstanceNumber_cdma:Ljava/util/concurrent/atomic/AtomicInteger;

.field protected static mInstanceNumber_gsm:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mInstanceNumber_cdma:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    sput-object v0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mInstanceNumber_gsm:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    sput-object v3, Lcom/android/internal/telephony/dataconnection/DataConnection;->mCustomerId:Ljava/lang/String;

    sput-object v3, Lcom/android/internal/telephony/dataconnection/DataConnection;->mIgnoreDNSCheckMCCList:Ljava/lang/String;
...
.method private constructor <init>(Lcom/android/internal/telephony/PhoneBase;Ljava/lang/String;ILcom/android/internal/telephony/dataconnection/DcTrackerBase;Lcom/android/internal/telephony/dataconnection/DcTesterFailBringUpAll;Lcom/android/internal/telephony/dataconnection/DcController;)V
    ...
    invoke-direct {p0, p2, v5}, Lcom/android/internal/util/StateMachine;-><init>(Ljava/lang/String;Landroid/os/Handler;)V

    iput-object v6, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDct:Lcom/android/internal/telephony/dataconnection/DcTrackerBase;

    iput v3, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mProfileId:I

    new-instance v5, Landroid/net/LinkProperties;

    invoke-direct {v5}, Landroid/net/LinkProperties;-><init>()V

    iput-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mLinkProperties:Landroid/net/LinkProperties;

    new-instance v5, Landroid/net/LinkCapabilities;

    invoke-direct {v5}, Landroid/net/LinkCapabilities;-><init>()V

    iput-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mLinkCapabilities:Landroid/net/LinkCapabilities;

    iput v7, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mRilRat:I

    iput v7, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDataRegState:I

    iput-object v6, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mApnContexts:Ljava/util/List;

    iput-object v6, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mReconnectIntent:Landroid/app/PendingIntent;
    ...
    iput-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mRetryManager:Lcom/android/internal/telephony/RetryManager;

    new-instance v5, Lcom/android/internal/telephony/dataconnection/DataConnection$DcDefaultState;

    invoke-direct {v5, p0, v6}, Lcom/android/internal/telephony/dataconnection/DataConnection$DcDefaultState;-><init>(Lcom/android/internal/telephony/dataconnection/DataConnection;Lcom/android/internal/telephony/dataconnection/DataConnection$1;)V

    iput-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDefaultState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcDefaultState;

    new-instance v5, Lcom/android/internal/telephony/dataconnection/DataConnection$DcInactiveState;

    invoke-direct {v5, p0, v6}, Lcom/android/internal/telephony/dataconnection/DataConnection$DcInactiveState;-><init>(Lcom/android/internal/telephony/dataconnection/DataConnection;Lcom/android/internal/telephony/dataconnection/DataConnection$1;)V

    iput-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mInactiveState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcInactiveState;

    new-instance v5, Lcom/android/internal/telephony/dataconnection/DataConnection$DcRetryingState;

    invoke-direct {v5, p0, v6}, Lcom/android/internal/telephony/dataconnection/DataConnection$DcRetryingState;-><init>(Lcom/android/internal/telephony/dataconnection/DataConnection;Lcom/android/internal/telephony/dataconnection/DataConnection$1;)V

    iput-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mRetryingState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcRetryingState;

    new-instance v5, Lcom/android/internal/telephony/dataconnection/DataConnection$DcActivatingState;

    invoke-direct {v5, p0, v6}, Lcom/android/internal/telephony/dataconnection/DataConnection$DcActivatingState;-><init>(Lcom/android/internal/telephony/dataconnection/DataConnection;Lcom/android/internal/telephony/dataconnection/DataConnection$1;)V

    iput-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mActivatingState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcActivatingState;

    new-instance v5, Lcom/android/internal/telephony/dataconnection/DataConnection$DcActiveState;

    invoke-direct {v5, p0, v6}, Lcom/android/internal/telephony/dataconnection/DataConnection$DcActiveState;-><init>(Lcom/android/internal/telephony/dataconnection/DataConnection;Lcom/android/internal/telephony/dataconnection/DataConnection$1;)V

    iput-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mActiveState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcActiveState;

    new-instance v5, Lcom/android/internal/telephony/dataconnection/DataConnection$DcDisconnectingState;

    invoke-direct {v5, p0, v6}, Lcom/android/internal/telephony/dataconnection/DataConnection$DcDisconnectingState;-><init>(Lcom/android/internal/telephony/dataconnection/DataConnection;Lcom/android/internal/telephony/dataconnection/DataConnection$1;)V

    iput-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDisconnectingState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcDisconnectingState;

    new-instance v5, Lcom/android/internal/telephony/dataconnection/DataConnection$DcDisconnectionErrorCreatingConnection;

    invoke-direct {v5, p0, v6}, Lcom/android/internal/telephony/dataconnection/DataConnection$DcDisconnectionErrorCreatingConnection;-><init>(Lcom/android/internal/telephony/dataconnection/DataConnection;Lcom/android/internal/telephony/dataconnection/DataConnection$1;)V

    iput-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDisconnectingErrorCreatingConnection:Lcom/android/internal/telephony/dataconnection/DataConnection$DcDisconnectionErrorCreatingConnection;

    const/16 v5, 0x12c

    invoke-virtual {p0, v5}, Lcom/android/internal/telephony/dataconnection/DataConnection;->setLogRecSize(I)V

    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/dataconnection/DataConnection;->setLogOnlyTransitions(Z)V

    const-string v5, "DataConnection constructor E"
    ...
    iput v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mCid:I

    new-instance v5, Lcom/android/internal/telephony/dataconnection/DcRetryAlarmController;
    ...
    invoke-direct {v5, v6, p0}, Lcom/android/internal/telephony/dataconnection/DcRetryAlarmController;-><init>(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/dataconnection/DataConnection;)V

    iput-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDcRetryAlarmController:Lcom/android/internal/telephony/dataconnection/DcRetryAlarmController;
    ...
    .local v1, "mHCmanager":Lcom/htc/customization/HtcCustomizationManager;
    const/4 v2, 0x0

    .local v2, "mHCreader":Lcom/htc/customization/HtcCustomizationReader;
    ...
    invoke-virtual {p0, v5}, Lcom/android/internal/telephony/dataconnection/DataConnection;->addState(Lcom/android/internal/util/State;)V

    iget-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mInactiveState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcInactiveState;

    iget-object v6, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDefaultState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcDefaultState;

    invoke-virtual {p0, v5, v6}, Lcom/android/internal/telephony/dataconnection/DataConnection;->addState(Lcom/android/internal/util/State;Lcom/android/internal/util/State;)V

    iget-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mActivatingState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcActivatingState;

    iget-object v6, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDefaultState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcDefaultState;

    invoke-virtual {p0, v5, v6}, Lcom/android/internal/telephony/dataconnection/DataConnection;->addState(Lcom/android/internal/util/State;Lcom/android/internal/util/State;)V

    iget-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mRetryingState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcRetryingState;

    iget-object v6, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDefaultState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcDefaultState;

    invoke-virtual {p0, v5, v6}, Lcom/android/internal/telephony/dataconnection/DataConnection;->addState(Lcom/android/internal/util/State;Lcom/android/internal/util/State;)V

    iget-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mActiveState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcActiveState;

    iget-object v6, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDefaultState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcDefaultState;

    invoke-virtual {p0, v5, v6}, Lcom/android/internal/telephony/dataconnection/DataConnection;->addState(Lcom/android/internal/util/State;Lcom/android/internal/util/State;)V

    iget-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDisconnectingState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcDisconnectingState;

    iget-object v6, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDefaultState:Lcom/android/internal/telephony/dataconnection/DataConnection$DcDefaultState;

    invoke-virtual {p0, v5, v6}, Lcom/android/internal/telephony/dataconnection/DataConnection;->addState(Lcom/android/internal/util/State;Lcom/android/internal/util/State;)V

    iget-object v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDisconnectingErrorCreatingConnection:Lcom/android/internal/telephony/dataconnection/DataConnection$DcDisconnectionErrorCreatingConnection;
    ...
    invoke-virtual {p0, v5}, Lcom/android/internal/telephony/dataconnection/DataConnection;->setInitialState(Lcom/android/internal/util/State;)V
    ...
    invoke-virtual {v1}, Lcom/htc/customization/HtcCustomizationManager;->readCID()Ljava/lang/String;

    move-result-object v5

    sput-object v5, Lcom/android/internal/telephony/dataconnection/DataConnection;->mCustomerId:Ljava/lang/String;

    const-string v5, "ignore_dns_check_mcc_list"
    ...
    sput-object v5, Lcom/android/internal/telephony/dataconnection/DataConnection;->mIgnoreDNSCheckMCCList:Ljava/lang/String;

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "mCustomerId = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    sget-object v6, Lcom/android/internal/telephony/dataconnection/DataConnection;->mCustomerId:Ljava/lang/String;
    ...
    const-string v6, "mIgnoreDNSCheckMCCList = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    sget-object v6, Lcom/android/internal/telephony/dataconnection/DataConnection;->mIgnoreDNSCheckMCCList:Ljava/lang/String;
    ...
    :goto_0
    const-string v5, "persist.radio.enableruim"
    ...
    :cond_1
    iput-boolean v3, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mUseRuimCard:Z
...
.method private IsProfileUpdateNeeded()Z
    .locals 4
    ...
    iget v2, v2, Lcom/android/internal/telephony/dataconnection/ApnSetting;->rat_type:I
    ...
    const-string v3, "IsProfileUpdateNeeded= "
    ...
    const-string v3, ", apn radio type="
    ...
    iget v3, v3, Lcom/android/internal/telephony/dataconnection/ApnSetting;->rat_type:I

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, ", current radio tech="
...
.method public static ReInitialDataConnectionCounter(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    const-string v0, "mInstanceNumbe is been initial to 0 "

    invoke-static {v0}, Lcom/android/internal/telephony/dataconnection/DataConnection;->slog(Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mInstanceNumber_gsm:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    sget-object v0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mInstanceNumber_cdma:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static ReInitialDataConnectionCounterExt(Lcom/android/internal/telephony/PhoneBase;)V
    .locals 3
    .param p0, "mPhone"    # Lcom/android/internal/telephony/PhoneBase;
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/PhoneBase;->getPhoneSlot()I

    move-result v1

    if-ne v0, v1, :cond_0

    const-string v0, "mInstanceNumber_slot2 has been initial to 0 "

    invoke-static {v0}, Lcom/android/internal/telephony/dataconnection/DataConnection;->slog(Ljava/lang/String;)V

    sget-object v0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mInstanceNumber_slot2:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_0
    const-string v0, "mInstanceNumber_slot1 has been initial to 0 "

    invoke-static {v0}, Lcom/android/internal/telephony/dataconnection/DataConnection;->slog(Ljava/lang/String;)V

    sget-object v0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mInstanceNumber_slot1:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method static synthetic access$3400(Lcom/android/internal/telephony/dataconnection/DataConnection;II)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/dataconnection/DataConnection;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method private configureRetry(Z)V
    ...
    invoke-virtual {v3, v0}, Lcom/android/internal/telephony/RetryManager;->configure(Ljava/lang/String;)Z
    ...
    const-string v1, "max_retries=infinite,5000,10000,20000,40000,80000,160000,320000"

    .local v1, "retryConfigDefault":Ljava/lang/String;
    :goto_0
    iget-object v3, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mRetryManager:Lcom/android/internal/telephony/RetryManager;

    invoke-virtual {v3, v1}, Lcom/android/internal/telephony/RetryManager;->configure(Ljava/lang/String;)Z
    ...
    const-string v4, "configureRetry: Could not configure using DEFAULT_DATA_RETRY_CONFIG="
    ...
    invoke-virtual {v3, v5, v7, v6}, Lcom/android/internal/telephony/RetryManager;->configure(III)Z

    .end local v1    # "retryConfigDefault":Ljava/lang/String;
    :cond_0
    :goto_1
    new-instance v3, Ljava/lang/StringBuilder;
    ...
    .restart local v1    # "retryConfigDefault":Ljava/lang/String;
    goto :goto_0
    ...
    .local v2, "retryConfigSecondary":Ljava/lang/String;
    :goto_2
    iget-object v3, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mRetryManager:Lcom/android/internal/telephony/RetryManager;
    ...
    .end local v2    # "retryConfigSecondary":Ljava/lang/String;
    :cond_3
    ...
    .restart local v2    # "retryConfigSecondary":Ljava/lang/String;
    goto :goto_2
.end method
...
.method public static get_mInstanceNumberofDC_slot1()Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 1
...
.method public static get_mInstanceNumberofDC_slot2()Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 1
...
.method private isDnsOkExt([Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-object v10, Lcom/android/internal/telephony/dataconnection/DataConnection;->mCustomerId:Ljava/lang/String;
...
.method private isIgnoreDnsMcc()Z
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->htcGetOperatorNumeric()Ljava/lang/String;

    move-result-object v2

    .local v2, "mccFromIMSI":Ljava/lang/String;
    sget-boolean v5, Lcom/android/internal/telephony/dataconnection/DataConnection;->mDualCardProject:Z
    ...
    invoke-virtual {v5, v6}, Lcom/htc/service/HtcTelephonyManager;->getNetworkOperatorExt(I)Ljava/lang/String;
    ...
    :goto_1
    :try_start_1
    sget-object v5, Lcom/android/internal/telephony/dataconnection/DataConnection;->mIgnoreDNSCheckMCCList:Ljava/lang/String;
    ...
    const-string v6, "isIgnoreDnsMcc: IMSI="
    ...
    .end local v1    # "mIgnoreDnsCheck":Z
    .end local v3    # "mccFromOperator":Ljava/lang/String;
    ...
    .restart local v1    # "mIgnoreDnsCheck":Z
    .restart local v3    # "mccFromOperator":Ljava/lang/String;
    :catch_0
    move-exception v0
    ...
    const-string v6, "isIgnoreDNSMCC: Can\'t split mcc from IMSI or Operator, e="
    ...
    const-string v6, "isIgnoreDNSMCC: Can\'t split mIgnoreDNSCheckMCCList, e="
...
.method static makeDataConnection(Lcom/android/internal/telephony/PhoneBase;ILcom/android/internal/telephony/dataconnection/DcTrackerBase;Lcom/android/internal/telephony/dataconnection/DcTesterFailBringUpAll;Lcom/android/internal/telephony/dataconnection/DcController;)Lcom/android/internal/telephony/dataconnection/DataConnection;
    ...
    sget-object v2, Lcom/android/internal/telephony/dataconnection/DataConnection;->mInstanceNumber_gsm:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    sget-object v2, Lcom/android/internal/telephony/dataconnection/DataConnection;->mInstanceNumber_cdma:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method static makeDataConnectionExt(Lcom/android/internal/telephony/PhoneBase;ILcom/android/internal/telephony/dataconnection/DcTrackerBase;Lcom/android/internal/telephony/dataconnection/DcTesterFailBringUpAll;Lcom/android/internal/telephony/dataconnection/DcController;)Lcom/android/internal/telephony/dataconnection/DataConnection;
    .locals 8
    .param p0, "phone"    # Lcom/android/internal/telephony/PhoneBase;
    .param p1, "id"    # I
    .param p2, "dct"    # Lcom/android/internal/telephony/dataconnection/DcTrackerBase;
    ...
    .end local v0    # "dc":Lcom/android/internal/telephony/dataconnection/DataConnection;
    .local v7, "dc":Ljava/lang/Object;
    :goto_0
    return-object v7

    .end local v7    # "dc":Ljava/lang/Object;
    :cond_0
    new-instance v0, Lcom/android/internal/telephony/dataconnection/DataConnection;
    ...
    .restart local v7    # "dc":Ljava/lang/Object;
    goto :goto_0
.end method
...
.method private notifyCheckIsDataAllowed(Lcom/android/internal/telephony/dataconnection/ApnContext;)V
    .locals 5
    .param p1, "apn"    # Lcom/android/internal/telephony/dataconnection/ApnContext;
    ...
    const-string v4, "notifyCheckIsDataAllowed: reqapn="
    ...
    invoke-static {v2, p1, v3}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    const-string v4, "notifyCheckIsDataAllowed: e="
...
.method private onConnect(Lcom/android/internal/telephony/dataconnection/DataConnection$ConnectionParams;)V
    ...
    :cond_0
    iput-wide v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mCreateTime:J

    iput-wide v5, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mLastFailTime:J
    ...
    iget-boolean v0, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mUseRuimCard:Z

    if-eqz v0, :cond_4

    const/4 v10, 0x0

    .local v10, "mdataProfile":I
    ...
    .restart local v10    # "mdataProfile":I
    goto :goto_2
...
.method private setLinkProperties(Lcom/android/internal/telephony/dataconnection/DataCallResponse;Landroid/net/LinkProperties;)Lcom/android/internal/telephony/dataconnection/DataCallResponse$SetupResult;
    ...
    invoke-direct {p0, v0, v3}, Lcom/android/internal/telephony/dataconnection/DataConnection;->isDnsOkExt([Ljava/lang/String;Ljava/lang/String;)Z

    move-result v1

    iget-object v3, p1, Lcom/android/internal/telephony/dataconnection/DataCallResponse;->dnses:[Ljava/lang/String;

    const-string v4, "DataCallResponse"

    invoke-direct {p0, v3, v4}, Lcom/android/internal/telephony/dataconnection/DataConnection;->isDnsOkExt([Ljava/lang/String;Ljava/lang/String;)Z

    move-result v3

    invoke-virtual {p1, v3}, Lcom/android/internal/telephony/dataconnection/DataCallResponse;->setDNSCheckResult(Z)V

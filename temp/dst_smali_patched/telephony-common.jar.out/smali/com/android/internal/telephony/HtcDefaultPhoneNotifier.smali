...
.field private static final PENDING_DATA_ACTIVITY_FOR_CALL_END__MS:I

.field private static final PENDING_DATA_ACTIVITY_FOR_CALL_START__MS:I
...
.method static synthetic access$000(Lcom/android/internal/telephony/HtcDefaultPhoneNotifier;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/HtcDefaultPhoneNotifier;
...
.method static synthetic access$100(Lcom/android/internal/telephony/HtcDefaultPhoneNotifier;ILcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/PhoneConstants$DataState;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/HtcDefaultPhoneNotifier;
    .param p1, "x1"    # I
    ...
    .param p5, "x5"    # Lcom/android/internal/telephony/PhoneConstants$DataState;

    .prologue
    invoke-direct/range {p0 .. p5}, Lcom/android/internal/telephony/HtcDefaultPhoneNotifier;->dispatchQueueEvent(ILcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/PhoneConstants$DataState;)V

    return-void
.end method

.method private dispatchQueueEvent(ILcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/PhoneConstants$DataState;)V
    .locals 0
    .param p1, "event"    # I
    .param p2, "sender"    # Lcom/android/internal/telephony/Phone;
    .param p3, "reason"    # Ljava/lang/String;
    .param p4, "apnType"    # Ljava/lang/String;
    .param p5, "state"    # Lcom/android/internal/telephony/PhoneConstants$DataState;
    ...
    :pswitch_6
    invoke-super {p0, p2, p3, p4, p5}, Lcom/android/internal/telephony/DefaultPhoneNotifier;->notifyDataConnection(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/PhoneConstants$DataState;)V
...
.method private eventEnqueue(ILcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/PhoneConstants$DataState;)Z
    .locals 10
    .param p1, "event"    # I
    .param p2, "sender"    # Lcom/android/internal/telephony/Phone;
    .param p3, "reason"    # Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/internal/telephony/HtcDefaultPhoneNotifier$PendingNotification;-><init>(Lcom/android/internal/telephony/HtcDefaultPhoneNotifier;ILcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/PhoneConstants$DataState;)V
...
.method public notifyDataActivity(Lcom/android/internal/telephony/Phone;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/internal/telephony/HtcDefaultPhoneNotifier;->eventEnqueue(ILcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/PhoneConstants$DataState;)Z
...
.method public notifyDataConnection(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/PhoneConstants$DataState;)V
    ...
    :cond_0
    invoke-super {p0, p1, p2, p3, p4}, Lcom/android/internal/telephony/DefaultPhoneNotifier;->notifyDataConnection(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/PhoneConstants$DataState;)V
